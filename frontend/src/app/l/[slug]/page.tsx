...
function PublicLoyaltyPageContent() {
  ...
  const stampSettings = {
    ...
    logo_url: campaignTexts.stamp_card_logo_url || campaignTexts.stamp_card_background || campaignTexts.brand_logo_url || settings?.stamp_card_logo_url || settings?.stamp_card_background || settings?.logo_url || settings?.brand_logo_url || settings?.metadata?.stamp_card_logo_url || settings?.metadata?.stamp_card_background || settings?.metadata?.brand_logo_url || status?.program?.metadata?.stamp_card_logo_url || status?.program?.metadata?.stamp_card_background || status?.program?.metadata?.brand_logo_url || null
  }
