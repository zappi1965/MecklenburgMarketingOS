...
function LandingTextEditor({store,q}:any){
 ...
 const initialLandingForm=()=>({
  ...
  show_staff_pin_on_counter:(q.metadata||{}).show_staff_pin_on_counter!==false,
 ...
 function normalizedPayload(){
  ...
  return {
   ...
   show_staff_pin_on_counter:f.show_staff_pin_on_counter!==false,
