...
function InternalToolsLegacyCenter({setView}:any){
 ...
 return <div className="backofficePage">
  <div className="head"><div><p className="eyebrow">Interne Werkzeuge</p><h1>Interne Werkzeuge</h1><p className="sub">Interne Verwaltung, Finanzen, Sicherheit, Systembetrieb und organisatorische Tools.</p></div><button className="btn secondary" onClick={()=>setView('dashboard')}>Zurück ins Frontoffice</button></div>
...
export default function App(){
 ...
 const labels:any={
   dashboard:'Dashboard',sales_workflow:'Verkaufsworkflow',production_validation:'Production Validation',smoke_test:'Smoke-Test',demo_live_guard:'Demo-/Live-Trennung',action_log:'Admin-Aktionslog',document_center:'Dokumenten-Zentrale',production_health:'Production Health',production_core:'Production Core',admin_tool_center:'Tool-Zentrale',admin_training:'Wissenstest',production_readiness:'Production Readiness',security_core_live:'Security Core',admin_profiles:'Admin Profile',main_landing:'Haupt-Landingpage',crm:'CRM',finance:'Rechnungen',tickets:'Tickets',booking:'Booking',pipeline:'Pipeline',automations:'Automationen',workflows:'Workflows',activity:'Aktivitäten',media:'Media Center',qr:'QR Kampagnen',demo_customers:'Test Kunden',demo_environment:'Interne Testumgebung',integrations:'Integrationen',packages:'Pakete & Billing',public_landing:'Öffentliche /l/[slug] Seite',loyalty:'Loyalty Programm',loyalty_rewards:'Rewards',loyalty_rules:'Reward Regeln',staff_codes:'Mitarbeitercode',loyalty_segments:'Loyalty Segmente',smart_loyalty:'Smart Loyalty V2',reviews:'Reviews',review_intelligence:'Review Intelligence',review_templates:'Antwortvorlagen',smart_automation:'Smart Automation',marketing_automation:'Marketing Automation',ai_assistant:'AI Business Assistant',customer_health:'Customer Health',customer_intelligence:'Customer Intelligence',dynamic_billing:'Dynamic Billing',revenue_forecasting:'Revenue Forecasting',revenue_share:'Revenue Share',package_recommendations:'Package Recommendations',package_matrix:'Paket-Matrix',retention_intelligence:'Retention Intelligence',consent_center:'Consent Center',segment_campaigns:'Segment Kampagnen',churn_prevention:'Churn Prevention',sumup_revenue_connection:'SumUp Integration',timeline_events:'Timeline Events',seo:'SEO Dashboard',review:'Review Funnel',customer_automations:'Automationen',customer_workflows:'Workflow Center',roles:'Rechte',kpi:'KPI Analytics',heatmap:'SEO Heatmap',success:'Client Success Score',advanced_reports:'Advanced Reports',knowledge:'Wissenscenter',competitors:'Wettbewerber Vergleich',onboarding:'Onboarding',reports:'Reports',approvals:'Freigaben',output_engine:'Output Engine',monthly_reports:'Monatsreport Generator',business_audit:'Google Business Audit',mini_audit:'Mini-Audit Generator',lead_scraper:'Lead Scraper',acquisition_campaigns:'Akquise-Kampagnen',offer_generator:'Angebotsgenerator',contract_generator:'Vertragsgenerator',health_scores:'Kunden-Erfolgsampel',dunning:'Mahnwesen',health_center:'Security & Health Center',security_center:'Security & Health Center'
 }
 const visibleNavKeys=role==='admin'?admin:customer
 const adminNavGroups=[
    {
      label:'Kunden & Betrieb',
      hint:'Dashboard, CRM, Kundenstatus, Termine und laufender Betrieb',
      tools:['dashboard','crm','customer_health','customer_intelligence','tickets','booking','media','onboarding','knowledge']
    },
    {
      label:'Akquise, Audits & Abschluss',
      hint:'Leads finden, Betriebe prüfen, Mini-Audits erstellen und Angebote vorbereiten',
      tools:['sales_workflow','lead_scraper','acquisition_campaigns','business_audit','mini_audit','offer_generator','contract_generator','pipeline']
    },
    {
      label:'Sichtbarkeit & Reputation',
      hint:'Google, SEO, KPIs, Reviews, Wettbewerber, Reports und Freigaben',
      tools:['integrations','seo','kpi','competitors','reviews','review_intelligence','review_templates','monthly_reports','reports','approvals']
    },
    {
      label:'QR, Loyalty & Automation',
      hint:'QR, Slug-Seiten, Punkte, Rewards, Workflows, Kampagnen und AI',
      tools:['qr','public_landing','loyalty','loyalty_rewards','loyalty_rules','staff_codes','loyalty_segments','smart_loyalty','retention_intelligence','consent_center','segment_campaigns','churn_prevention','automations','workflows','smart_automation','marketing_automation','ai_assistant','customer_workflows','output_engine','timeline_events']
    },
    {
      label:'Finanzen & Pakete',
      hint:'Rechnungen, Mahnwesen, Forecast, Billing, Paketlogik und Empfehlungen',
      tools:['finance','sumup_revenue_connection','dunning','dynamic_billing','revenue_forecasting','revenue_share','package_recommendations','package_matrix','packages']
    },
    {
      label:'System, Sicherheit & Verwaltung',
      hint:'Interne Werkzeuge, Production, Security, Logs, Smoke-Tests und Admins',
      tools:['production_core','production_validation','production_health','document_center','action_log','demo_live_guard','smoke_test','production_readiness','security_core_live','security_center','admin_tool_center','admin_profiles','main_landing','demo_environment','admin_training']
    }
  ]
  const customerNavGroups=[
   {label:'Übersicht & Wissen',hint:'Portalstart, Onboarding, Wissen, Reports und Freigaben',tools:['dashboard','onboarding','knowledge','reports','approvals']},
   {label:'Sichtbarkeit & Reviews',hint:'Bewertungen, SEO, Integrationen, KPI und Wettbewerber',tools:['reviews','integrations','seo','kpi','competitors','customer_health','customer_intelligence']},
   {label:'QR & Loyalty',hint:'QR, Landingpage, Punkte, Rewards und Loyalty-Regeln',tools:['qr','public_landing','loyalty','loyalty_rewards','loyalty_rules','staff_codes','loyalty_segments','smart_loyalty']},
   {label:'Betrieb & Automation',hint:'Workflows, Kampagnen, AI, Termine, Rechnungen und Dateien',tools:['customer_workflows','smart_automation','marketing_automation','ai_assistant','booking','finance','tickets','media','packages']}
 ]
