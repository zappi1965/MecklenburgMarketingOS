...
const packageDefs:any={
  ...
  Growth:{
    ...
    tools:['Dashboard','Rechnungen','Tickets','Booking','Integrationen','Media Center','Pakete & Billing','SEO Dashboard','Review Funnel','Automationen','']
  },
  Premium:{
    price:899,
    base:'Growth',
    displayFeatures:['Alles aus Growth-Paket','Automationen','Workflows','Rechte','Review Funnel'],
    tools:['Dashboard','Rechnungen','Tickets','Booking','Integrationen','Media Center','Pakete & Billing','SEO Dashboard','Review Funnel','Automationen','','','KPI Analytics','SEO Heatmap','Client Success Score','Advanced Reports']
  }
}
...
export default function App(){
 ...
 const packageToolRoutes:any={'SEO Dashboard':'seo','Review Funnel':'review','Automationen':'customer_automations','':'customer_workflows','':'roles','KPI Analytics':'kpi','SEO Heatmap':'heatmap','Client Success Score':'success','Advanced Reports':'advanced_reports'}
