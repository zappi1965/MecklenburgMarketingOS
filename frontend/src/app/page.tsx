...
function LandingTextEditor({store,q}:any){
 ...
 const initialLandingForm=()=>({
  ...
  stamp_card_background:(q.metadata||{}).stamp_card_background||(q.metadata||{}).stamp_card_logo_url||(q.metadata||{}).brand_logo_url||'',
