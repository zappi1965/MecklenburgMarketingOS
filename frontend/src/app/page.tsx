...
export default function App(){
 ...
 const adminNavGroups=[
   ...
   {label:'Backoffice',hint:'Interne Funktionen, Production, Sicherheit, Logs, Admins und Automationen',tools:['backoffice','production_core','production_validation','production_health','action_log','demo_live_guard','smoke_test','production_readiness','security_core_live','security_center','admin_tool_center','admin_profiles','main_landing','demo_environment','admin_training','automations','workflows','smart_automation','marketing_automation','ai_assistant','customer_workflows','timeline_events','retention_intelligence','consent_center','segment_campaigns','churn_prevention']}
 ]
