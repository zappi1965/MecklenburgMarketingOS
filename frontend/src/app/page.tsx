...
function QRCodes({store,cid,setCid,role='admin',activeView='qr'}:any){
 ...
 const sectionFromView=(v:string)=>['public_landing','loyalty','loyalty_rewards','loyalty_rules','staff_codes','loyalty_segments','smart_loyalty'].includes(v)?v:'campaigns'
 ...
 const individuallyEnabledSections=new Set(safeList(store.data.customer_tool_access)
  ...
  .flatMap((k:string)=>{
   const m:any={qr:['campaigns'],public_landing:['public_landing'],loyalty:['loyalty'],loyalty_rewards:['loyalty_rewards'],loyalty_rules:['loyalty_rules'],staff_codes:['staff_codes'],loyalty_segments:['loyalty_segments'],smart_loyalty:['smart_loyalty'],Punkteprogramm:['loyalty'],Prämien:['loyalty_rewards'],Regeln:['loyalty_rules'],Mitarbeitercodes:['staff_codes'],Kundengruppen:['loyalty_segments'],Bonusstufen:['smart_loyalty']}
   return m[k]||[]
  }))
 const starterQrSections=['campaigns','public_landing']
 const growthQrSections=['campaigns','public_landing','staff_codes']
 const loyaltyAddonSections=['public_landing','staff_codes','loyalty','loyalty_rewards','loyalty_rules','loyalty_segments','smart_loyalty']
...
export default function App(){
 ...
 const packageToolRoutes:any={
   ...
   'Rückhol-Chancen':'churn_prevention',
...
{view==='documents_billing'&&<CustomerDocumentsBilling store={store} cid={cid}/>}
 ...
 {['qr','public_landing','loyalty','loyalty_rewards','loyalty_rules','staff_codes','loyalty_segments','smart_loyalty'].includes(view)&&<QRCodes store={store} cid={cid} setCid={role==='admin'?setCid:undefined} role={role} activeView={view}/>}
