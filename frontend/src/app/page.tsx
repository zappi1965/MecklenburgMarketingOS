...
function QRCodes({store,cid,setCid,role='admin',activeView='qr'}:any){
 ...
 const allQrSections=[
  {key:'campaigns',label:'Kampagnen',hint:'QR-Code, Ziel, Bewertung und Grundregeln'},
  {key:'public_landing',label:'QR Zielseite',hint:'Öffentliche Seite hinter dem QR-Code'},
  {key:'loyalty',label:'Punkteprogramm',hint:'Punkte pro Scan und Grundlogik'},
  {key:'loyalty_rewards',label:'Prämien',hint:'Rabatte, Vorteile und Einlösungen'},
  {key:'loyalty_rules',label:'Regeln',hint:'Wann Punkte oder Prämien greifen'},
  {key:'staff_codes',label:'Mitarbeitercodes',hint:'PINs zur Bestätigung vor Ort'},
  {key:'loyalty_segments',label:'Kundengruppen',hint:'Stammkunden, VIPs und inaktive Kunden'},
  {key:'smart_loyalty',label:'Bonusstufen',hint:'Level, Multiplikatoren und VIP-Stufen'}
 ]
 ...
 const growthQrSections=['campaigns','public_landing','loyalty','loyalty_rewards','staff_codes','loyalty_segments']
 const loyaltyAddonSections=['loyalty','loyalty_rewards','loyalty_rules','staff_codes','loyalty_segments','smart_loyalty']
...
function LandingTextEditor({store,q}:any){
 ...
 const [f,setF]=useState({
  ...
  subline:md.hero_subline||'Sammle Punkte, sichere dir Prämien und werde VIP.',
 ...
 async function save(){
  ...
  try{
   ...
   await store.load?.()
   setMsg('Finale QR-Zielseiten-Regeln wurden im Backend gespeichert. Die öffentliche /l/-Seite nutzt diese Werte sofort beim nächsten Scan.')
  }catch(e:any){
   try{
    ...
    setMsg('Finale Regeln wurden direkt in qr_campaigns gespeichert. Backend-Sync war nicht erreichbar, die QR-Zielseite liest die Werte aus der Kampagne/Metadata.')
