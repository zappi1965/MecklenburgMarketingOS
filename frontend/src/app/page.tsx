...
import CustomerLandingV26 from '@/components/public/CustomerLandingV26'
import DealBuilder from '@/components/marketing/DealBuilder'
...
const qrScanUrl=(slug:string)=>`${appOrigin()}/q/${slug}`
...
const featureDescriptions:any={
  ...
  'Kundenbindung & Wiederkehrer':'Erkennt inaktive Kunden, Churn-Risiko, VIPs und konkrete Reaktivierungsaktionen.',
  'Einwilligungen':'Verwaltet Werbeeinwilligungen, Abmeldelinks und Double-Opt-in-Freigaben.',
  'Consent Center & Double-Opt-in':'Verwaltet Werbeeinwilligungen, Abmeldelinks und Double-Opt-in-Freigaben.',
  'Kundenaktionen':'Startet Aktionen für Stammkunden, inaktive Kunden, VIPs und neue Kunden.',
  'Segment-Kampagnen':'Startet Aktionen für Stammkunden, inaktive Kunden, VIPs und neue Kunden.',
  ...
  'Rückhol-Chancen':'Zeigt Kunden, die wahrscheinlich nicht wiederkommen, und schlägt Rückholaktionen vor.',
  'Churn Prevention':'Zeigt Kunden, die wahrscheinlich nicht wiederkommen, und schlägt Rückholaktionen vor.'
}
Object.assign(featureDescriptions, {
  'QR Kampagnen verwalten':'QR-Kampagnen mit Zielseite, Scans, Bewertungen und optionalem Punkteprogramm.',
  'QR Zielseite':'Öffentliche Zielseite hinter dem QR-Code für Bewertung, Aktion oder Punkteprogramm.',
  'Punkteprogramm':'Einfaches Punkteprogramm über QR-Code für wiederkehrende Kunden.',
  'Prämien':'Einlösbare Prämien, Rabatte oder Vorteile für gesammelte Punkte.',
  'Regeln':'Legt fest, wann Punkte vergeben und Prämien freigeschaltet werden.',
  'Mitarbeitercodes':'Mitarbeiter bestätigen Einlösungen oder Aktionen per PIN/Code.',
  'Kundengruppen':'Gruppen wie Stammkunden, inaktive Kunden, VIPs oder fast erreichte Prämien.',
  'Bonusstufen':'Einfache Bonus-Level, Multiplikatoren und VIP-Stufen für Stammkunden.',
  ...
  'Automatische Regeln':'Regelbasierte Abläufe aus QR, Bewertungen und Kundenbindung.',
  'Smart Automation':'Regelbasierte Abläufe aus QR, Bewertungen und Kundenbindung.',
  'Automatische Aktionen':'Reaktivierung, Bewertungsbooster und Kundenaktionen automatisch vorbereiten.',
  'Marketing Automation':'Reaktivierung, Bewertungsbooster und Kundenaktionen automatisch vorbereiten.',
  'KI-Empfehlungen':'Verständliche Hinweise, Chancen, Risiken und nächste Schritte.',
  'Projektstatus':'Statuswert für Sichtbarkeit, Nutzung, Tickets, Rechnungen und offene Aufgaben.',
  'Customer Health':'Statuswert für Sichtbarkeit, Nutzung, Tickets, Rechnungen und offene Aufgaben.',
  'Empfehlungen':'Erkennt nächste sinnvolle Maßnahmen, Risiken und mögliche Erweiterungen.',
  'Customer Intelligence':'Erkennt nächste sinnvolle Maßnahmen, Risiken und mögliche Erweiterungen.',
  'Nutzung & Abrechnung':'Zeigt Nutzung, Zusatzleistungen und abrechnungsrelevante Mengen verständlich.',
  'Dynamic Billing':'Zeigt Nutzung, Zusatzleistungen und abrechnungsrelevante Mengen verständlich.',
  'Umsatzprognose':'Schätzt erwartete Umsätze aus Paket, Pipeline und laufender Nutzung.',
  'Umsatzbeteiligung':'Berechnet interne Umsatzanteile und Beteiligungslogik.',
  'Paket-Empfehlung':'Empfiehlt passende Paket-Erweiterungen auf Basis von Bedarf und Nutzung.',
  'Package Recommendations':'Empfiehlt passende Paket-Erweiterungen auf Basis von Bedarf und Nutzung.',
  'Paket-Matrix':'Paketlogik, Tool-Zugriffe und Feature-Matrix.',
  'Timeline Events':'Chronologische Verknüpfung aus QR, Punkteprogramm, Reviews, Billing und Tickets.',
...
const packageDefs:any={
  Starter:{
    price:199,
    base:null,
    displayFeatures:['Google Business Optimierung','SEO KPI Übersicht','SEO Heatmap','QR-Code Kampagne ohne Punkteprogramm','Reports & Rechnungen'],
    tools:['Dashboard','Integrationen','SEO Dashboard','KPI Analytics','SEO Heatmap','QR Kampagnen','Reports','Rechnungen','Media Center']
  },
  Growth:{
    price:499,
    base:'Starter',
    displayFeatures:['Alles aus Starter-Paket','Bewertungen aktiv sammeln','QR Zielseite','Punkteprogramm','Prämien','Kundenbindung','Einwilligungen','Kundenaktionen'],
    tools:[
      'Dashboard','Integrationen','SEO Dashboard','SEO Analytics','SEO Heatmap','KPI Analytics','QR Kampagnen','Reports','Rechnungen','Media Center',
      'Reviews','QR Zielseite','Punkteprogramm','Prämien','Kundenbindung','Einwilligungen','Kundenaktionen','Freigaben'
    ]
  },
  Premium:{
    price:899,
    base:'Growth',
    displayFeatures:['Alles aus Growth-Paket','Bonusstufen','Regeln','Mitarbeitercodes','Rückhol-Chancen','Service Recovery','Automatische Aktionen','KI-Empfehlungen','Umsatzübersicht','Kundenportal Pro'],
    tools:[
      'Dashboard','Integrationen','SEO Dashboard','SEO Analytics','SEO Heatmap','KPI Analytics','QR Kampagnen','Reports','Rechnungen','Media Center',
      'Reviews','QR Zielseite','Punkteprogramm','Prämien','Regeln','Mitarbeitercodes','Kundengruppen','Bonusstufen',
      'Kundenbindung','Einwilligungen','Kundenaktionen','Rückhol-Chancen','Automatische Regeln','Automatische Aktionen','KI-Empfehlungen',
      'Projektstatus','Empfehlungen','Nutzung & Abrechnung','Umsatzprognose','Umsatzbeteiligung','Paket-Empfehlung','Paket-Matrix','Pipeline','Timeline Events','Booking','Tickets','Pakete & Billing','Wissenscenter','Onboarding','Freigaben'
    ]
  }
...
const defaultMainLandingSettings:any={
 ...
 logo_url:'/brand/mecklenburg-marketing-logo-full.png',
 ...
 faq:[
  {question:'Brauche ich eine Website?',answer:'Nein. QR-/QR-Zielseiten und Google Business Optimierung funktionieren auch ohne eigene Website.'},
 ...
 package_cta_label:'Paket anfragen',
 package_addon_headline:'Individuell erweiterbar',
 package_addon_subline:'Starte mit dem passenden Paket und erweitere es jederzeit um einzelne Tools.',
 package_addon_note:'Alle Funktionen sind flexibel erweiterbar und können einzeln zum Paket hinzugebucht werden.',
 package_addon_cta_label:'Individuelles Setup anfragen',
 package_form_title:'Paket anfragen',
 package_form_subline:'Sag uns kurz, für welchen Betrieb du anfragst. Die Anfrage geht direkt an Mecklenburg Marketing und erscheint im Admin-Dashboard.',
 package_form_success:'Danke! Deine Anfrage wurde übermittelt. Wir melden uns schnellstmöglich.',
 ...
 optional_tools:['Review-Booster','QR-Kampagnen','Loyalty-System','Lead-Suche','Monatsreports','Monatsreport PDF-Versand','Kundenbindung','Einwilligungen','Kundenaktionen','Rückhol-Chancen','Service Recovery','Mail-Domain & Consent Guard','Go-Live Cockpit','Tool-Reife Center','Completeness Audit','Kundenportal Pro'],
 ...
 demo_audit:{
  badge:'Demo-Audit',
  business:'Beispiel: Café in Schwerin',
  score:'72/100',
  score_label:'Sichtbarkeitspotenzial',
  summary:'Gutes Grundprofil, aber zu wenig aktuelle Bilder, ungenutzte Bewertungsansprache und keine klare monatliche Maßnahmenlogik.',
  findings:['Google Business wirkt gepflegt, aber nicht aktiv genug','Bewertungen werden nicht systematisch eingesammelt','Fotos, Leistungen und Beiträge werden unregelmäßig aktualisiert'],
  wins:['QR-Review-Kampagne starten','Neue Bilder und Leistungen hinterlegen','Monatsreport mit nächster Empfehlung erstellen']
 },
 monthly_headline:'Was du jeden Monat bekommst',
 monthly_subline:'Nicht nur ein Dashboard – sondern eine klare Übersicht, was gemacht wurde, was es gebracht hat und was als Nächstes sinnvoll ist.',
 monthly_items:[
  {title:'Mehr Sichtbarkeit',description:'Google Business, SEO-Signale und lokale Auffindbarkeit werden laufend geprüft.'},
  {title:'Mehr Bewertungen',description:'Review-Funnel und QR-Kampagnen helfen, zufriedene Kunden einfacher zu aktivieren.'},
  {title:'Klare nächste Maßnahmen',description:'Du bekommst verständliche Empfehlungen statt unübersichtlicher Tool-Listen.'}
 ],
 portal_preview_headline:'So sieht dein Kundenportal aus',
 portal_preview_subline:'Der Kunde sieht keine komplizierte Admin-Oberfläche, sondern die wichtigsten Punkte für seinen Betrieb.',
 portal_preview_items:['Was wurde gemacht?','Was hat es gebracht?','Welche Freigaben sind offen?','Was ist die nächste Empfehlung?'],
 trust_headline:'Lokal, nachvollziehbar und persönlich',
 ...
 packages:{
  Starter:{headline:'Starter',price:199,setupFee:399,audience:'Für Betriebe, die Google sichtbar machen und eine einfache QR-Kampagne ohne Punkteprogramm starten wollen.',description:'Google Business Optimierung mit SEO KPI Übersicht, Heatmap, QR-Code-Kampagne und Kundenübersicht für Reports/Rechnungen.',features:['Google Business Optimierung','SEO KPI Übersicht','SEO Heatmap','QR-Code Kampagne ohne Punkteprogramm','Reports & Rechnungen im Kundenportal']},
  Growth:{headline:'Growth',price:499,setupFee:749,audience:'Für Betriebe, die zusätzlich Bewertungen, Punkteprogramm und Kundenbindung nutzen wollen.',description:'Alles aus Starter plus Bewertungen, Punkteprogramm, Kundenbindung, Einwilligungen und Kundenaktionen.',features:['Alles aus Starter','Bewertungen aktiv sammeln','Punkteprogramm & Prämien','Kundenbindung','Einwilligungen & Kundenaktionen']},
  Premium:{headline:'Premium',price:899,setupFee:1199,audience:'Für Betriebe, die Kundenbindung, Automationen und Steuerung maximal ausbauen wollen.',description:'Alles aus Growth plus Bonusstufen, Rückhol-Chancen, Service Recovery, automatische Aktionen, KI-Empfehlungen und erweitertes Kundenportal.',features:['Alles aus Growth','Bonusstufen & Regeln','Rückhol-Chancen & Service Recovery','Automatische Aktionen & KI-Empfehlungen','Kundenportal Pro & Umsatzübersicht']}
 }
}
...
const restoredPackageToolFeatures:any={
 Starter:['Google Business Optimierung','SEO KPI Übersicht','SEO Heatmap','QR-Code Kampagne ohne Punkteprogramm','Reports & Rechnungen'],
 Growth:['Bewertungen aktiv sammeln','Punkteprogramm','Kundenbindung','Einwilligungen','Kundenaktionen'],
 Premium:['Bonusstufen','Rückhol-Chancen','Service Recovery','Automatische Aktionen & KI','Kundenportal Pro']
}
...
const seed:any={
 ...
 customer_reactivation_settings:[],
 customer_reactivation_links:[],
 customer_reactivation_events:[],
 package_requests:[],
 invoices:[],
 tickets:[],
 ticket_messages:[],
...
const backendAuthenticatedTables=new Set(['qr_campaigns','public_landing_pages','loyalty_programs','loyalty_rewards','loyalty_reward_rules','staff_codes','loyalty_customers','loyalty_transactions','loyalty_reward_redemptions','loyalty_security_settings','loyalty_member_security_scores','review_feedback','customer_tool_access','customer_reactivation_settings','customer_reactivation_links','customer_reactivation_events','package_requests'])
...
function isSoftDeletedCustomer(c:any){const status=String(c?.status||'').toLowerCase();return c?.is_deleted===true||c?.deleted===true||c?.archived===true||Boolean(c?.deleted_at||c?.archived_at||c?.removed_at)||['deleted','gelöscht','geloescht','archived','archiviert','removed'].includes(status)}
function liveCustomers(d:any){return (d.customers||[]).filter((c:any)=>!isDemoRecord(c)&&!isSoftDeletedCustomer(c)).map(normalizeCustomerRow).filter(Boolean)}
...
function Search({items,value,onChange,placeholder}:any){
 ...
 return <div style={{position:'relative'}}><input className="input" placeholder={placeholder} value={s&&!q?customerDisplayName(s):q} onChange={e=>{setQ(e.target.value)}}/>{q&&<div className="card floating">{list.length===0&&<div className="sub">Kein Treffer gefunden.</div>}{list.map((x:any)=><button className="nav" key={x.id||x.email||x.name} onClick={()=>{onChange(x.id);setQ('')}}>{customerDisplayName(x)}<div className="sub">{[x.branch,x.package_name,x.email].filter(Boolean).join(' · ')||'Keine weiteren Daten'}</div></button>)}</div>}</div>
}
...
const rewardFieldMeta:any={
 name:{label:'Prämienname',help:'Interner und öffentlicher Name der Prämie. Dieser Name erscheint später für den Endkunden auf der QR-Zielseite.',example:'Beispiel: Kostenloser Kaffee, 10% Rabatt, Gratis Haarschnitt'},
 reward_type:{label:'Prämienart',help:'Ordnet die Prämie fachlich ein. Das hilft bei Übersicht, Reporting und späteren Auswertungen.',example:'Typische Werte: Rabatt, Gratisprodukt, Gutschein, Service, VIP-Vorteil'},
 required_points:{label:'Benötigte Punkte',help:'So viele Punkte muss der Endkunde besitzen, bevor diese Prämie eingelöst werden kann.',example:'Beispiel: 100 = ab 100 Punkten sichtbar und einlösbar'},
 title:{label:'Prämienname',help:'Interner und öffentlicher Name der Prämie. Dieser Name erscheint später für den Endkunden auf der QR-Zielseite.',example:'Beispiel: Kostenloser Kaffee, 10% Rabatt, Gratis Haarschnitt'},
...
const sharedFieldMeta:any={
 ...
 purpose:{label:'Zweck',help:'Legt fest, ob der QR-Code für Punkteprogramm, Google Reviews oder beides genutzt wird.',example:'loyalty, review oder both'},
 ...
 rotate_qr_after_scan:{label:'QR nach Nutzung automatisch erneuern',help:'Wenn aktiv, wird nach erfolgreicher Teilnahme automatisch ein neuer QR-Code mit denselben Kampagnenparametern erzeugt. Der alte QR wird deaktiviert.',example:'Für digitale Displays oder streng kontrollierte Einmal-QRs.'},
 ...
 headline:{label:'Überschrift',help:'Hauptüberschrift auf der öffentlichen QR-Zielseite.',example:'Willkommen im Bonusclub'},
...
function defaultFormValue(view:string,k:string,title:string){
 if(view==='loyalty_rewards'){
  ...
  if(k==='points'||k==='required_points')return 0
  return ''
 }
 if(['points','score','quantity','unit','expected','confidence','gross','percent','tools','price','max_redemptions_per_member','max_scans_per_member','daily_scan_limit_per_member','weekly_scan_limit','scan_cooldown_minutes','daily_point_limit_per_member','weekly_point_limit_per_member','suspicion_score_threshold'].includes(k))return 0
...
function onboardingStepsFor(customer:any){return [
 ...
 ['qr','QR-/QR-Zielseite vorbereiten',true],
...
function ProfessionalLanding({lp,setRole,setActiveAdmin}:any){
 ...
 const stepIcons=['⌕','➜','▣']
 const audit={...defaultMainLandingSettings.demo_audit,...(lp.demo_audit||{})}
 const auditFindings=Array.isArray(audit.findings)&&audit.findings.length?audit.findings:defaultMainLandingSettings.demo_audit.findings
 const auditWins=Array.isArray(audit.wins)&&audit.wins.length?audit.wins:defaultMainLandingSettings.demo_audit.wins
 const monthlyItems=Array.isArray(lp.monthly_items)&&lp.monthly_items.length?lp.monthly_items:defaultMainLandingSettings.monthly_items
 const portalItems=Array.isArray(lp.portal_preview_items)&&lp.portal_preview_items.length?lp.portal_preview_items:defaultMainLandingSettings.portal_preview_items
 const trustPoints=Array.isArray(lp.trust_points)&&lp.trust_points.length?lp.trust_points:defaultMainLandingSettings.trust_points
 const [inquiry,setInquiry]=useState<any>(null)
 const [inquiryForm,setInquiryForm]=useState<any>({name:'',company:'',email:'',phone:'',message:''})
 const [inquiryMsg,setInquiryMsg]=useState('')
 const [inquiryBusy,setInquiryBusy]=useState(false)
 function openPackageInquiry(pkg:string){
  const message=pkg==='Individuelles Setup'
   ? 'Hallo Mecklenburg Marketing, ich interessiere mich für ein individuelles Setup und möchte wissen, welche Tools für meinen Betrieb sinnvoll sind.'
   : `Hallo Mecklenburg Marketing, ich interessiere mich für das Paket ${pkg} und möchte weitere Informationen erhalten.`
  setInquiry(pkg)
  setInquiryForm((p:any)=>({...p,message}))
  setInquiryMsg('')
 }
 async function submitPackageInquiry(e:any){
  e?.preventDefault?.()
  if(!inquiryForm.name||!inquiryForm.email){setInquiryMsg('Bitte Name und E-Mail ausfüllen.');return}
  setInquiryBusy(true);setInquiryMsg('Anfrage wird gesendet...')
  try{
 ...
 return <div className="landing proLanding">
  <div className="landingNav proLandingNav">
   <div className="logo hasImage">
    <img className="brandLogoImg landingLogoImg" src={lp.logo_url||'/brand/mecklenburg-marketing-logo-full.png'} alt={lp.logo_alt||lp.nav_title||lp.brand_name||'Mecklenburg Marketing Logo'}/>
   ...
   <div className="proHeroMockShell">
    <div className="proMock proHeroMockPrimary">
     ...
     <div className="proHeroMockHead">
      <div className="proHeroMockBrand"><div className="proHeroMockBrandMark">M</div><div><b>Analytics</b><div className="sub">Live-Dashboard</div></div></div>
      <Badge>Auswertung</Badge>
     </div>
     <div className="proHeroMetricRow">{heroMetrics.map((m:any)=><div className="proHeroMetricTile" key={m.label}><span>{m.label}</span><strong>{m.value}</strong></div>)}</div>
     <div className="chartLine proHeroChart">{Array.from({length:14},(_,i)=><span key={i} style={{height:`${28+(i*9)%82}px`}} />)}</div>
    </div>
    <div className="proHeroFloatingCard recommendationCard"><div className="proHeroFloatingLabel">Nächste Empfehlung</div><strong>Google Business Fotos aktualisieren</strong><span>Neue Bilder ergänzen und Bewertungs-Booster für mehr Vertrauen starten.</span></div>
    <div className="proHeroFloatingCard analyticsCard"><div className="proHeroFloatingLabel">Analytics</div><strong>Performance im Blick</strong><span>Sichtbarkeit, Leads und Bewertungen zentral auswerten und aktualisieren.</span></div>
   </div>
  </section>
  ...
  <section className="proSection proStepsSection">
   ...
   <div className="proStepsList">
    {steps.slice(0,3).map((s:any,i:number)=><div className="proStepRow" key={`${s.title}-${i}`}>
      <div className="proStepRail"><div className="proStepIcon">{stepIcons[i]||String(i+1)}</div><div className="proStepNumber">{i+1}</div>{i<2&&<div className="proStepConnector"/>}</div>
      <div className="proStepCard"><div className="proStepText"><h3>{s.title}</h3><p>{s.description}</p>{i===2&&<div className="proStepMetricsInline">{metrics.map((m:any)=><div className="proInlineMetric" key={m.label}><strong>{m.value}</strong><span>{m.label}</span></div>)}</div>}</div></div>
    </div>)}
   </div>
  </section>

  <section className="proSection proofBlockSection">
   <div className="packageShowcaseHead"><h2>{lp.proof_headline||defaultMainLandingSettings.proof_headline}</h2><p>{lp.proof_subline||defaultMainLandingSettings.proof_subline}</p></div>
   <div className="grid2 proofGrid">
    <div className="demoAuditCard"><div className="auditTop"><Badge>{audit.badge||'Demo-Audit'}</Badge><strong>{audit.score||'72/100'}</strong></div><h3>{audit.business||'Beispielbetrieb'}</h3><p>{audit.summary}</p><div className="auditScoreLabel">{audit.score_label||'Sichtbarkeitspotenzial'}</div><div className="auditProgress"><span style={{width:`${Math.min(100,Math.max(10,Number(String(audit.score||'72').replace(/[^0-9]/g,'')||72)))}%`}}/></div><div className="auditColumns"><div><b>Gefunden</b>{auditFindings.map((x:any,i:number)=><span key={`${x}-${i}`}>• {x}</span>)}</div><div><b>Nächste Hebel</b>{auditWins.map((x:any,i:number)=><span key={`${x}-${i}`}>• {x}</span>)}</div></div></div>
    <div className="portalPreviewCard"><span className="packageEyebrow">Kundenportal</span><h3>{lp.portal_preview_headline||defaultMainLandingSettings.portal_preview_headline}</h3><p>{lp.portal_preview_subline||defaultMainLandingSettings.portal_preview_subline}</p><div className="portalPreviewList">{portalItems.map((x:any,i:number)=><div className="portalPreviewItem" key={`${x}-${i}`}><b>{i+1}</b><span>{x}</span></div>)}</div></div>
   </div>
  </section>

  <section className="proSection monthlyProofSection">
   <div className="packageShowcaseHead"><h2>{lp.monthly_headline||defaultMainLandingSettings.monthly_headline}</h2><p>{lp.monthly_subline||defaultMainLandingSettings.monthly_subline}</p></div>
   <div className="grid3 monthlyProofGrid">{monthlyItems.map((m:any,i:number)=><div className="monthlyProofCard" key={`${m.title}-${i}`}><span>{String(i+1).padStart(2,'0')}</span><h3>{m.title}</h3><p>{m.description}</p></div>)}</div>
  </section>

  <section className="proSection trustStrip"><div><span className="packageEyebrow">Vertrauen</span><h2>{lp.trust_headline||defaultMainLandingSettings.trust_headline}</h2><p>{lp.trust_subline||defaultMainLandingSettings.trust_subline}</p></div><div className="trustStripPoints">{trustPoints.map((x:any,i:number)=><span key={`${x}-${i}`}>{x}</span>)}</div></section>
...
function CustomerDocumentsBilling({store,cid}:any){
 const invoices=safeList(store.data.invoices).filter((i:any)=>i.customer_id===cid).sort((a:any,b:any)=>String(b.created_at).localeCompare(String(a.created_at)))
 const reports=safeList(store.data.monthly_reports).filter((r:any)=>r.customer_id===cid).sort((a:any,b:any)=>String(b.created_at).localeCompare(String(a.created_at)))
 const files=safeList(store.data.customer_files).filter((f:any)=>f.customer_id===cid)
 const openInvoices=invoices.filter((i:any)=>i.status!=='Bezahlt').length
 return <><Head title="Dokumente & Rechnungen" sub="Alles, was wir dir hochladen: Rechnungen, Reports, Angebote, Verträge und Dateien." action={<LiveModeBadge/>}/><div className="grid4"><Metric label="Offene Rechnungen" value={openInvoices}/><Metric label="Reports" value={reports.length}/><Metric label="Dateien" value={files.length}/><Metric label="Letztes Dokument" value={files[0]?.created_at?new Date(files[0].created_at).toLocaleDateString('de-DE'):'–'}/></div><div className="grid2"><Card title="Rechnungen">{invoices.length===0&&<EmptyState icon="€" title="Noch keine Rechnung vorhanden">Sobald eine Rechnung für dich hochgeladen oder erstellt wurde, erscheint sie hier.</EmptyState>}{invoices.map((i:any)=><div className="item" key={i.id}><div><b>{i.invoice_number||'Rechnung'}</b><div className="sub">{i.service_type||'Leistung'} · {eur(i.amount)} · {i.status||'Offen'}</div></div><div className="toolbarActions"><Badge type={i.status==='Bezahlt'?'green':i.status==='Überfällig'?'red':'yellow'}>{i.status||'Offen'}</Badge><button className="btn secondary" onClick={()=>i.pdf_url||i.pdf_base64?openInvoicePdf(i):appToast('Für diese Rechnung ist noch kein PDF hinterlegt.')}>PDF öffnen</button></div></div>)}</Card><Card title="Reports">{reports.length===0&&<EmptyState icon="📄" title="Noch kein Report vorhanden">Sobald wir einen Monatsreport hochladen, findest du ihn hier.</EmptyState>}{reports.map((r:any)=><div className="item" key={r.id}><div><b>{r.title||'Monatsreport'}</b><div className="sub">{r.status||'Freigegeben'} · {r.created_at?new Date(r.created_at).toLocaleDateString('de-DE'):'ohne Datum'}</div><p className="sub">{r.summary||'Report und Empfehlungen für deinen Betrieb.'}</p></div><button className="btn secondary" onClick={()=>openPdfDocument(r.title||'Report',`Report für ${cname(store.data,cid)}`,reportBody(store,cid,r),{status:r.status||'Report'})}>Öffnen</button></div>)}</Card></div><Card title="Alle Dateien"><FileList store={store} cid={cid}/></Card></>
}
function qrKpiSnapshot(store:any,cid:string,rows:any[]){
 const tx=safeList(store.data.loyalty_transactions).filter((x:any)=>x.customer_id===cid)
 const redemptions=safeList(store.data.loyalty_reward_redemptions).filter((x:any)=>x.customer_id===cid)
 const members=safeList(store.data.loyalty_customers).filter((x:any)=>x.customer_id===cid)
 const totalScans=rows.reduce((sum:number,q:any)=>sum+Number(q.scans??q.scan_count??q.total_scans??q.metadata?.scans??0),0)
 const conversions=rows.reduce((sum:number,q:any)=>sum+Number(q.conversions??q.conversion_count??q.metadata?.conversions??0),0)
 const pointsFromTx=tx.reduce((sum:number,t:any)=>sum+Number(t.points??t.points_delta??t.amount??0),0)
 const pointsFallback=rows.reduce((sum:number,q:any)=>sum+(Number(q.scans??q.scan_count??q.metadata?.scans??0)*Number(q.points_per_scan??q.metadata?.points_per_scan??0)),0)
 return {active:rows.filter((q:any)=>q.active!==false).length,totalScans,conversions,points:pointsFromTx||pointsFallback,rewards:redemptions.length,members:members.length}
}
...
function QRCodes({store,cid,setCid,role='admin',activeView='qr'}:any){
 const [customer,setCustomer]=useState(cid)
 const [f,setF]=useState<any>({title:'Bewertungs-QR',purpose:'review',points_per_scan:1,max_scans_per_member:1,daily_scan_limit_per_member:1,scan_cooldown_minutes:0,daily_point_limit_per_member:1,suspicion_score_threshold:70,internal_email:'',internal_from:1,internal_to:3,google_from:4,google_to:5,google_review_url:'',require_rescan_for_points:true,rotate_qr_after_scan:false})
 const sectionFromView=(v:string)=>['public_landing','loyalty','loyalty_rewards','loyalty_rules','staff_codes','reactivation','actions','loyalty_segments','smart_loyalty'].includes(v)?v:(['deal_of_week','marketing_deals','offers_actions'].includes(v)?'actions':(['churn_prevention','retention_intelligence','customer_reactivation'].includes(v)?'reactivation':'campaigns'))
 const [section,setSection]=useState(sectionFromView(activeView))
 useEffect(()=>{if(cid)setCustomer(cid)},[cid])
 useEffect(()=>{setSection(sectionFromView(activeView))},[activeView])
 const activeCustomer=customer||cid
 const rows=(store.data.qr_campaigns||[]).filter((q:any)=>q.customer_id===activeCustomer)
 const [selectedReactivationCampaignId,setSelectedReactivationCampaignId]=useState('')
 useEffect(()=>{
  if(rows.length===0){setSelectedReactivationCampaignId('');return}
  if(!selectedReactivationCampaignId||!rows.some((q:any)=>String(q.id)===String(selectedReactivationCampaignId)))setSelectedReactivationCampaignId(String(rows[0].id))
 },[activeCustomer,rows.map((q:any)=>String(q.id)).join('|')])
 const selectedReactivationCampaign=rows.find((q:any)=>String(q.id)===String(selectedReactivationCampaignId))||rows[0]||null
 const allQrSections=[
  {key:'campaigns',label:'Kampagnen',hint:'QR-Code und zugewiesene Kampagnen'},
  {key:'public_landing',label:'QR Zielseite',hint:'Texte, Punkte, Prämien und finale Regeln'},
  {key:'staff_codes',label:'Mitarbeitercodes',hint:'PINs zur Bestätigung vor Ort'},
  {key:'actions',label:'Aktionen & Angebote',hint:'Wochenangebote und Angebots-QRs'},
  {key:'reactivation',label:'Rückholaktion',hint:'Inaktive Kunden per persönlichem Link zurückholen'}
 ]
 const packageName=cpkg(store.data,activeCustomer)
 const isStarterPackage=packageName==='Starter'
 const isStarterCustomer=role==='customer'&&isStarterPackage
 const canCreateQrCampaign=!isStarterCustomer
 const individuallyEnabledSections=new Set(safeList(store.data.customer_tool_access)
  .filter((x:any)=>String(x.customer_id||'')===String(activeCustomer||'')&&x.enabled!==false)
  .map((x:any)=>String(x.tool_key||x.tool||'').trim())
  .flatMap((k:string)=>{
   const m:any={qr:['campaigns'],public_landing:['public_landing'],loyalty:['loyalty'],loyalty_rewards:['loyalty_rewards'],loyalty_rules:['loyalty_rules'],staff_codes:['staff_codes'],deal_of_week:['actions'],actions:['actions'],offers_actions:['actions'],reactivation:['reactivation'],customer_reactivation:['reactivation'],inactive_customer_reactivation:['reactivation'],loyalty_segments:['loyalty_segments'],smart_loyalty:['smart_loyalty'],Punkteprogramm:['loyalty'],Prämien:['loyalty_rewards'],Regeln:['loyalty_rules'],Mitarbeitercodes:['staff_codes'],'Aktionen & Angebote':['actions'],Wochenaktionen:['actions'],Rückholaktionen:['reactivation'],Rueckholaktionen:['reactivation'],Kundengruppen:['loyalty_segments'],Bonusstufen:['smart_loyalty']}
   return m[k]||[]
  }))
 const starterQrSections=['campaigns','public_landing']
 const growthQrSections=['campaigns','public_landing','actions','staff_codes']
 const loyaltyAddonSections=['public_landing','staff_codes','actions','reactivation','loyalty','loyalty_rewards','loyalty_rules','loyalty_segments','smart_loyalty']
 const starterHasLoyaltyAddon=isStarterPackage&&loyaltyAddonSections.some((k:string)=>individuallyEnabledSections.has(k))
 const canUseLoyaltyForQr=!isStarterPackage||starterHasLoyaltyAddon
 const showLoyaltyKpis=canUseLoyaltyForQr
 const showCampaignPointSettings=false
 const allowedKeys=role==='admin'?allQrSections.map((s:any)=>s.key):Array.from(new Set([...(isStarterPackage?starterQrSections:packageName==='Growth'?growthQrSections:allQrSections.map((s:any)=>s.key)),...Array.from(individuallyEnabledSections)]))
 const allowedQrSections=allQrSections.filter((s:any)=>allowedKeys.includes(s.key))
 ...
 async function repairCustomerQrCampaigns(){
  ...
  try{
   ...
   for(const q of currentRows){
    ...
    const linkedRewards=rewards.filter((r:any)=>String(r.qr_campaign_id||'')===String(q.id)||String(r.loyalty_program_id||'')===String(program?.id||'')||String(r.metadata?.qr_slug||'')===String(slug))
 ...
 async function createLocalQr(seedData:any={}){
  ...
  await store.create('notifications',{customer_id:activeCustomer,title:'QR Kampagne erstellt',message:`Für ${cname(store.data,activeCustomer)} wurde ${row.title} erstellt.`,type:'admin_change',actor_name:'DominiqueMM'})
  store.notify?.('QR Kampagne erstellt')
 }
 async function v34CreateQrCampaign(){
  if(!canCreateQrCampaign){store.notify?.('Im Starter-Paket werden QR-Kampagnen vom Admin zugewiesen.');return}
  try{
   const createLoyalty=canUseLoyaltyForQr&&f.purpose!=='review'
   const r=await v33FunctionalClient.createQrCampaign(activeCustomer,{title:f.title||'Neue QR Kampagne',purpose:canUseLoyaltyForQr?f.purpose:'review',mode:canUseLoyaltyForQr?f.purpose:'review',points_per_scan:canUseLoyaltyForQr?Number(f.points_per_scan||10):0,max_scans_per_member:Number(f.max_scans_per_member||0),daily_scan_limit_per_member:Number(f.daily_scan_limit_per_member||0),scan_cooldown_minutes:Number(f.scan_cooldown_minutes||0),daily_point_limit_per_member:Number(f.daily_point_limit_per_member||0),suspicion_score_threshold:Number(f.suspicion_score_threshold||70),google_review_url:f.google_review_url,require_rescan_for_points:canUseLoyaltyForQr&&Number(f.points_per_scan||0)>0?f.require_rescan_for_points!==false:false,rotate_qr_after_scan:canUseLoyaltyForQr&&!!f.rotate_qr_after_scan,create_loyalty:createLoyalty})
   const persistedQr={...(r.qr_campaign||{}),customer_id:(r.qr_campaign?.customer_id||activeCustomer),title:(r.qr_campaign?.title||f.title||'Neue QR Kampagne'),name:(r.qr_campaign?.name||r.qr_campaign?.title||f.title||'Neue QR Kampagne'),slug:(r.qr_campaign?.slug||r.slug||''),public_url:r.public_url_path?`${appOrigin()}${r.public_url_path}`:(r.qr_campaign?.public_url||''),target_url:(r.qr_campaign?.target_url||(r.public_url_path||'')),purpose:(r.qr_campaign?.purpose||(canUseLoyaltyForQr?f.purpose:'review')),active:r.qr_campaign?.active!==false,status:r.qr_campaign?.status||'Aktiv',created_at:r.qr_campaign?.created_at||new Date().toISOString()}
   ...
   setF({...f,title:''})
   setCid?.(activeCustomer)
  }catch(e:any){
   if(isDuplicateKeyError(e)){await store.load?.();store.notify?.('QR Kampagne war bereits gespeichert und wurde neu geladen.');return}
   if(isBackendAuthError(e)){store.notify?.('QR wurde nicht lokal gespeichert: Backend ist nicht authentifiziert. Bitte neu einloggen und 2FA bestätigen.');return}
   if(!allowLocalWriteFallback()){store.notify?.(`QR nicht gespeichert: ${compactLiveError(e)}`);return}
   await createLocalQr();store.notify?.(`Backend nicht erreichbar, QR lokal erstellt`)
  }
 }
 const sectionTitle=(allowedQrSections.find((s:any)=>s.key===section)||allowedQrSections[0]||allQrSections[0]).label
 if(section==='public_landing')return <><Head title="QR Zielseite" sub="Texte, Punkte, Limits, Prämien und finale Regeln werden hier pro Kampagne gespeichert."/><QrSectionTabs/><QrKpiCards/>{role==='admin'&&<CentralCustomerSelector store={store} cid={activeCustomer} setCid={(id:string)=>{setCustomer(id);setCid?.(id)}} title="Kunde für QR-Zielseite auswählen" sub="Punkte, Prämien und finale Regeln beziehen sich auf diesen Kunden."/>}<V42PublicLandingManager store={store} cid={activeCustomer}/></>
 if(section==='actions')return <><Head title="Aktionen & Angebote" sub="Konkrete kaufbare Angebote und Wochenaktionen als Ergänzung zu QR-Kampagnen. Bonusaktionen wie doppelte Punkte bleiben in der QR-Zielseite."/><QrSectionTabs/><QrKpiCards/>{role==='admin'&&<CentralCustomerSelector store={store} cid={activeCustomer} setCid={(id:string)=>{setCustomer(id);setCid?.(id)}} title="Kunde für Aktionen & Angebote auswählen" sub="Angebotsseiten und Schaufenster-QRs beziehen sich auf diesen Kunden."/>}<div className="grid2"><Card title="Saubere Trennung"><div className="sub"><b>Bonusaktion:</b> doppelte Punkte, Extra-Stempel oder Bewertungsbonus → unter „QR Zielseite“ einstellen.<br/><b>Angebotsaktion:</b> konkretes Angebot, Rabatt, Happy Hour oder Wochenmenü → hier als öffentliche Aktionsseite erstellen.</div></Card><Card title="Beispiel"><div className="sub">„Cappuccino + Croissant für 5,90 € bis Sonntag“ bekommt einen eigenen Link/QR-Code. „Heute 2 Stempel pro Kaffee“ bleibt eine QR-/Loyalty-Regel.</div></Card></div><DealBuilder preferredCustomerId={activeCustomer} embedded /></>
 if(section==='reactivation')return <><Head title="Rückholaktion" sub="Inaktive Loyalty-Kunden über persönliche Einmal-Links und E-Mail zurückholen."/><QrSectionTabs/><QrKpiCards/>{role==='admin'&&<CentralCustomerSelector store={store} cid={activeCustomer} setCid={(id:string)=>{setCustomer(id);setCid?.(id)}} title="Kunde für Rückholaktion auswählen" sub="Die Rückholaktion bezieht sich auf diesen Kunden und eine konkrete QR-Zielseite."/>}{rows.length===0?<Card title="Noch keine QR-Zielseite"><div className="sub">Erstelle zuerst unter „QR Zielseite“ eine Kampagne. Danach kannst du hier die Rückholaktion konfigurieren.</div></Card>:<Card title="QR-Kampagne für Rückholaktion auswählen"><label className="formField"><span>QR-Kampagne</span><select className="input" value={selectedReactivationCampaignId} onChange={e=>setSelectedReactivationCampaignId(e.target.value)}>{rows.map((q:any)=><option key={q.id} value={q.id}>{q.title||q.name||q.slug} · /l/{q.slug}</option>)}</select><div className="fieldHelp">Die Rückholaktion wird nur für die ausgewählte QR-Zielseite bearbeitet.</div></label></Card>}{selectedReactivationCampaign&&<ReactivationPanel key={selectedReactivationCampaign.id} store={store} q={selectedReactivationCampaign}/>}</>
 if(section==='staff_codes')return <><Head title="Mitarbeitercodes" sub="PINs zur Bestätigung vor Ort. Punkte und Prämien bleiben unter QR Zielseite."/><QrSectionTabs/><QrKpiCards/>{role==='admin'&&<CentralCustomerSelector store={store} cid={activeCustomer} setCid={(id:string)=>{setCustomer(id);setCid?.(id)}} title="Kunde für Mitarbeitercodes auswählen" sub="Die Codes beziehen sich auf diesen Kunden."/>}<V30ToolModule view="staff_codes" store={store} cid={activeCustomer} role={role} setCid={setCid}/></>
 if(section!=='campaigns'){
  return <><Head title="QR Zielseite" sub={`Bereich ${sectionTitle} wurde bereinigt: Punkte, Prämien und Regeln werden zentral unter QR Zielseite gepflegt.`}/><QrSectionTabs/><QrKpiCards/>{role==='admin'&&<CentralCustomerSelector store={store} cid={activeCustomer} setCid={(id:string)=>{setCustomer(id);setCid?.(id)}} title="Kunde für QR-Konfiguration auswählen" sub="Alle QR-Bereiche beziehen sich auf diesen Kunden."/>}<V42PublicLandingManager store={store} cid={activeCustomer}/></>
 }
 return <><Head title="QR Kampagnen & Aktionen" sub={isStarterCustomer?"Zugewiesene QR-Kampagnen ansehen und Zielseite/Bewertungslogik prüfen. Neue Kampagnen werden vom Admin angelegt.":"QR-Kampagnen anlegen/zuweisen. Punkte, Prämien und Bonusaktionen liegen unter QR Zielseite; konkrete Wochenangebote unter Aktionen & Angebote."} action={canCreateQrCampaign?<button className="btn" onClick={v34CreateQrCampaign}>QR Kampagne erstellen</button>:null}/><QrSectionTabs/><QrKpiCards/>{isStarterCustomer&&<Card title="Starter: QR-Kampagnen werden zugewiesen"><div className="sub">Du kannst bestehende, dir zugewiesene QR-Kampagnen ansehen, öffnen und die QR-Zielseite prüfen. Neue QR-Kampagnen werden im Starter-Paket vom Admin erstellt und freigegeben.</div></Card>}{!isStarterCustomer&&<div className="grid2"><Card title="Kunde & Kampagne">{role==='admin'?<Search items={allCustomers(store.data)} value={activeCustomer} onChange={(id:string)=>{setCustomer(id);setCid?.(id)}} placeholder="Kunde für QR-Kampagne suchen"/>:<div className="item"><b>Kunde</b><span>{cname(store.data,activeCustomer)}</span></div>}<input className="input" placeholder="Kampagnentitel, z. B. Google Bewertung am Tresen" value={f.title} onChange={e=>setF({...f,title:e.target.value})}/><select className="input" value={canUseLoyaltyForQr?f.purpose:'review'} onChange={e=>setF({...f,purpose:e.target.value})}><option value="review">Nur Google Bewertungen / Aktion</option>{canUseLoyaltyForQr&&<option value="loyalty">Punkteprogramm</option>}{canUseLoyaltyForQr&&<option value="both">Bewertung + Punkteprogramm</option>}</select>{showCampaignPointSettings&&<input className="input" type="number" min="0" placeholder="Punkte pro Scan, bei Bewertungs-QR optional 0" value={f.points_per_scan} onChange={e=>setF({...f,points_per_scan:Number(e.target.value)})}/>}{showCampaignPointSettings&&<><div className="grid2 mini"><input className="input" type="number" min="0" placeholder="Max. Einlösungen pro Endkunde, 0 = unbegrenzt" value={f.max_scans_per_member} onChange={e=>setF({...f,max_scans_per_member:Number(e.target.value)})}/><input className="input" type="number" min="0" placeholder="Cooldown in Minuten zwischen Scans" value={f.scan_cooldown_minutes} onChange={e=>setF({...f,scan_cooldown_minutes:Number(e.target.value)})}/></div><div className="grid2 mini"><input className="input" type="number" min="0" placeholder="Punkte-Tageslimit pro Endkunde" value={f.daily_point_limit_per_member||0} onChange={e=>setF({...f,daily_point_limit_per_member:Number(e.target.value)})}/><input className="input" type="number" min="0" max="100" placeholder="Missbrauchs-Warnschwelle, z. B. 70" value={f.suspicion_score_threshold||70} onChange={e=>setF({...f,suspicion_score_threshold:Number(e.target.value)})}/></div><label className="checkline"><input type="checkbox" checked={f.require_rescan_for_points!==false} onChange={e=>setF({...f,require_rescan_for_points:e.target.checked})}/> Für neue Punkte immer erneuten QR-Scan verlangen</label><label className="checkline"><input type="checkbox" checked={!!f.rotate_qr_after_scan} onChange={e=>setF({...f,rotate_qr_after_scan:e.target.checked})}/> Nach erfolgreicher Teilnahme automatisch neuen QR-Code erzeugen</label></>}<div className="sub">{isStarterPackage?(starterHasLoyaltyAddon?'Loyalty ist für diesen Starter-Kunden einzeln freigeschaltet. Admins können Punkte- oder Kombi-QRs anlegen; der Kunde sieht nur zugewiesene Kampagnen.':'Starter nutzt hier nur Bewertungs-/Aktions-QR ohne Punkteprogramm.'):'Punkte, Prämien und Regeln werden nach der Erstellung ausschließlich unter QR Zielseite gepflegt.'}</div><input className="input" placeholder="Interne Feedback-E-Mail für kritische Bewertungen" value={f.internal_email} onChange={e=>setF({...f,internal_email:e.target.value})}/><input className="input" placeholder="Google Bewertungslink des Kunden" value={f.google_review_url} onChange={e=>setF({...f,google_review_url:e.target.value})}/></Card><Card title="Bewertungslogik"><div className="row"><input className="input" type="number" min="1" max="5" value={f.internal_from} onChange={e=>setF({...f,internal_from:Number(e.target.value)})}/><input className="input" type="number" min="1" max="5" value={f.internal_to} onChange={e=>setF({...f,internal_to:Number(e.target.value)})}/></div><div className="sub">Sternebereich für internes Feedback</div><div className="row"><input className="input" type="number" min="1" max="5" value={f.google_from} onChange={e=>setF({...f,google_from:Number(e.target.value)})}/><input className="input" type="number" min="1" max="5" value={f.google_to} onChange={e=>setF({...f,google_to:Number(e.target.value)})}/></div><div className="sub">Sternebereich für Google-Weiterleitung</div></Card></div>}{isStarterCustomer&&rows.length===0&&<Card title="Noch keine zugewiesene QR-Kampagne"><div className="sub">Sobald der Admin eine QR-Kampagne freigibt, erscheint sie hier.</div></Card>}<Card title={isStarterCustomer?"Zugewiesene QR-Kampagnen":"Aktive QR-Kampagnen"}>{rows.length===0&&<div className="sub">{isStarterCustomer?'Noch keine zugewiesene Kampagne für deinen Betrieb.':'Noch keine Kampagne für diesen Kunden.'}</div>}{rows.map((q:any)=>{const slug=q.slug||slugifyLocal(q.title||q.name||q.id);const url=(q.target_url&&String(q.target_url).startsWith('/q/'))?`${appOrigin()}${q.target_url}`:(q.public_url&&String(q.public_url).startsWith('/q/'))?`${appOrigin()}${q.public_url}`:qrScanUrl(slug);const landingUrl=publicSlugUrl(slug);const nextQrUrl=q.metadata?.next_qr_slug?qrScanUrl(q.metadata.next_qr_slug):'';const mode=q.purpose||q.mode||q.metadata?.purpose||'review';return <div className="item" key={q.id}><V424QrImage value={url}/><div><b>{q.title||q.name}</b><div className="sub">{slug} · Typ: {mode==='both'?'Bewertung + Punkte':mode==='review'?'Google Bewertung':'Punkteprogramm'} · {q.points_per_scan||q.metadata?.points_per_scan||0} Punkte</div><div className="sub">Gesamtlimit: {Number(q.max_scans_per_member ?? q.metadata?.max_scans_per_member ?? 0) || '∞'}x · Tageslimit: {Number(q.daily_scan_limit_per_member ?? q.metadata?.daily_scan_limit_per_member ?? 0) || '∞'}x · Cooldown: {Number(q.scan_cooldown_minutes ?? q.metadata?.scan_cooldown_minutes ?? 0) || 0} Min. · Punkte/Tag: {Number(q.daily_point_limit_per_member ?? q.metadata?.daily_point_limit_per_member ?? 0) || '∞'} · Warnschwelle: {Number(q.suspicion_score_threshold ?? q.metadata?.suspicion_score_threshold ?? 70)}</div><div className="sub">{q.active===false?'Inaktiv':'Aktiv'} · {q.internal_from||1}-{q.internal_to||3} intern · {q.google_from||4}-{q.google_to||5} Google · {(q.metadata?.require_rescan_for_points||q.require_rescan_for_points)?'Refresh-Schutz aktiv':'Refresh-Schutz aus'}{q.metadata?.rotate_qr_after_scan?' · QR-Rotation aktiv':''}</div><div className="toolbarActions"><button className="btn secondary" onClick={()=>window.open(url,'_blank')}>QR-Scan öffnen</button><button className="btn secondary" onClick={()=>window.open(landingUrl,'_blank')}>Zielseite-Vorschau</button>{(q.google_review_url||q.metadata?.google_review_url)&&<button className="btn secondary" onClick={()=>window.open(q.google_review_url||q.metadata?.google_review_url,'_blank')}>Google Bewertung öffnen</button>}<button className="btn secondary" onClick={()=>navigator.clipboard?.writeText(url)}>QR-Link kopieren</button><QrAssetActions slug={slug} title={q.title||q.name||'Scanne & Punkte sammeln'} customerName={cname(store.data,activeCustomer)} compact/>{nextQrUrl&&<button className="btn secondary" onClick={()=>navigator.clipboard?.writeText(nextQrUrl)}>Neuen QR-Link kopieren</button>}{allowedQrSections.some((s:any)=>s.key==='public_landing')&&<button className="btn secondary" onClick={()=>setSection('public_landing')}>Zielseite bearbeiten</button>}{!isStarterCustomer&&<button className="btn secondary" onClick={()=>store.update('qr_campaigns',q.id,{active:q.active===false,status:q.active===false?'Aktiv':'Inaktiv'})}>{q.active===false?'Aktivieren':'Deaktivieren'}</button>}{role==='admin'&&<button className="btn secondary" onClick={()=>store.remove('qr_campaigns',q.id)}>Löschen</button>}</div></div></div>})}</Card><V42PublicLandingPreview campaigns={rows} customer={cobj(store.data,activeCustomer)}/></>
}
...
function V42PublicLandingPreview({campaigns,customer}:any){
 ...
 const previewUrl=publicSlugUrl(slug)
 const scanUrl=qrScanUrl(slug)
 const nextQrUrl=q?.metadata?.next_qr_slug?qrScanUrl(q.metadata.next_qr_slug):''
 return <Card title="Öffentliche QR-Zielseite Preview">{q?<div className="grid2"><div className="phonePreview"><iframe src={`/l/${slug}`}/></div><div><b>{customer?.name||'Kunde'}</b><p className="sub">Preview der Endkundenseite. Der echte QR-Code nutzt den geschützten Scan-Link über /q/[slug].</p><div className="qrExport"><V424QrImage value={scanUrl}/><div><b>{scanUrl}</b><div className="sub">Vorschau: {previewUrl}</div><div className="toolbarActions"><button className="btn secondary" onClick={()=>window.open(`/l/${slug}`,'_blank')}>Preview öffnen</button><button className="btn secondary" onClick={()=>navigator.clipboard?.writeText(scanUrl)}>QR-Link kopieren</button></div></div></div></div></div>:<div className="sub">Erstelle zuerst eine QR-Kampagne. Danach erscheint hier automatisch die Preview der öffentlichen Endkundenseite.</div>}</Card>
}
...
function MainLandingPageEditor({store}:any){
 ...
 function addPackageFeature(pkg:string){setPackage(pkg,{features:[...packageFeatureList(pkg),'Neue Leistung']})}
 function removePackageFeature(pkg:string,i:number){setPackage(pkg,{features:packageFeatureList(pkg).filter((_:any,idx:number)=>idx!==i)})}
 function optionalToolList(){return Array.isArray(f.optional_tools)?f.optional_tools:defaultMainLandingSettings.optional_tools}
 function patchOptionalTool(i:number,value:string){const next=[...optionalToolList()];next[i]=value;setF({...f,optional_tools:next})}
 function addOptionalTool(){setF({...f,optional_tools:[...optionalToolList(),'Neues Tool']})}
 function removeOptionalTool(i:number){setF({...f,optional_tools:optionalToolList().filter((_:any,idx:number)=>idx!==i)})}
 ...
 const audit={...defaultMainLandingSettings.demo_audit,...(f.demo_audit||{})}
 function setAudit(patch:any){setF({...f,demo_audit:{...audit,...patch}})}
 function auditFindings(){return Array.isArray(audit.findings)?audit.findings:defaultMainLandingSettings.demo_audit.findings}
 function auditWins(){return Array.isArray(audit.wins)?audit.wins:defaultMainLandingSettings.demo_audit.wins}
 function patchAuditList(kind:'findings'|'wins',i:number,value:string){const next=[...(kind==='findings'?auditFindings():auditWins())];next[i]=value;setAudit({[kind]:next})}
 function addAuditList(kind:'findings'|'wins'){const next=[...(kind==='findings'?auditFindings():auditWins()),kind==='findings'?'Neue Erkenntnis':'Neuer Hebel'];setAudit({[kind]:next})}
 function removeAuditList(kind:'findings'|'wins',i:number){const next=(kind==='findings'?auditFindings():auditWins()).filter((_:any,idx:number)=>idx!==i);setAudit({[kind]:next})}
 function monthlyList(){return Array.isArray(f.monthly_items)?f.monthly_items:defaultMainLandingSettings.monthly_items}
 function patchMonthly(i:number,patch:any){const next=[...monthlyList()];next[i]={...next[i],...patch};setF({...f,monthly_items:next})}
 function addMonthly(){setF({...f,monthly_items:[...monthlyList(),{title:'Neuer Monatswert',description:'Beschreibung ergänzen.'}]})}
 function removeMonthly(i:number){setF({...f,monthly_items:monthlyList().filter((_:any,idx:number)=>idx!==i)})}
 function portalList(){return Array.isArray(f.portal_preview_items)?f.portal_preview_items:defaultMainLandingSettings.portal_preview_items}
 function patchPortal(i:number,value:string){const next=[...portalList()];next[i]=value;setF({...f,portal_preview_items:next})}
 function addPortal(){setF({...f,portal_preview_items:[...portalList(),'Neuer Portalpunkt']})}
 function removePortal(i:number){setF({...f,portal_preview_items:portalList().filter((_:any,idx:number)=>idx!==i)})}
 function trustList(){return Array.isArray(f.trust_points)?f.trust_points:defaultMainLandingSettings.trust_points}
 function patchTrust(i:number,value:string){const next=[...trustList()];next[i]=value;setF({...f,trust_points:next})}
 function addTrust(){setF({...f,trust_points:[...trustList(),'Neuer Vertrauenspunkt']})}
 function removeTrust(i:number){setF({...f,trust_points:trustList().filter((_:any,idx:number)=>idx!==i)})}
 async function save(){
 ...
 return <>
  ...
  <Card title="Vertrauensbereich bearbeiten"><input className="input" value={f.trust_headline||''} onChange={e=>setF({...f,trust_headline:e.target.value})} placeholder="Überschrift Vertrauensbereich"/><textarea className="input textarea" value={f.trust_subline||''} onChange={e=>setF({...f,trust_subline:e.target.value})} placeholder="Beschreibung Vertrauensbereich"/>{trustList().map((x:any,i:number)=><div className="toolEditRow" key={`trust-${i}`}><input className="input" value={x||''} onChange={e=>patchTrust(i,e.target.value)} placeholder={`Vertrauenspunkt ${i+1}`}/><button className="btn secondary" onClick={()=>removeTrust(i)}>−</button></div>)}<button className="btn secondary" onClick={addTrust}>Vertrauenspunkt hinzufügen</button></Card>
  ...
  <Card title="Paketbereich bearbeiten"><input className="input" value={f.package_headline||''} onChange={e=>setF({...f,package_headline:e.target.value})} placeholder="Überschrift über der Paketauflistung"/><textarea className="input textarea" value={f.package_subline||''} onChange={e=>setF({...f,package_subline:e.target.value})} placeholder="Kurzbeschreibung oberhalb der Pakete"/><input className="input" value={f.package_cta_label||''} onChange={e=>setF({...f,package_cta_label:e.target.value})} placeholder="Buttontext in Paketkarten, z. B. Paket anfragen"/><div className="grid2"><input className="input" value={f.package_form_title||''} onChange={e=>setF({...f,package_form_title:e.target.value})} placeholder="Titel Kontaktformular"/><input className="input" value={f.package_form_submit_label||''} onChange={e=>setF({...f,package_form_submit_label:e.target.value})} placeholder="Absenden-Button Kontaktformular"/></div><textarea className="input textarea" value={f.package_form_subline||''} onChange={e=>setF({...f,package_form_subline:e.target.value})} placeholder="Erklärungstext im Kontaktformular"/><input className="input" value={f.package_form_success||''} onChange={e=>setF({...f,package_form_success:e.target.value})} placeholder="Erfolgsmeldung nach Anfrage"/><div className="grid3 packageEditorGrid">{Object.keys(packageDefs).map(pkg=>{const p=(f.packages||{})[pkg]||{};const features=packageFeatureList(pkg);return <Card key={pkg} title={pkg}><input className="input" value={p.headline||pkg} onChange={e=>setPackage(pkg,{headline:e.target.value})} placeholder={`Anzeigename für ${pkg}`}/><textarea className="input textarea" value={p.audience||''} onChange={e=>setPackage(pkg,{audience:e.target.value})} placeholder="Für wen ist das Paket geeignet?"/><textarea className="input textarea" value={p.description||''} onChange={e=>setPackage(pkg,{description:e.target.value})} placeholder={`Nutzenbeschreibung für ${pkg}`}/><div className="sub">Kernleistungen auf der Startseite:</div>{features.map((feature:any,i:number)=><div className="toolEditRow" key={`${pkg}-${i}`}><input className="input" value={feature||''} onChange={e=>patchPackageFeature(pkg,i,e.target.value)} placeholder={`Leistung ${i+1}`}/><button className="btn secondary" onClick={()=>removePackageFeature(pkg,i)}>−</button></div>)}<button className="btn secondary" onClick={()=>addPackageFeature(pkg)}>Leistung hinzufügen</button><div className="sub">Preis und Paketlogik kommen weiterhin aus der zentralen Paketlogik.</div></Card>})}</div><hr/><div className="grid2"><div><input className="input" value={f.package_addon_headline||''} onChange={e=>setF({...f,package_addon_headline:e.target.value})} placeholder="Erweiterungsbox: Label, z. B. Individuell erweiterbar"/><textarea className="input textarea" value={f.package_addon_subline||''} onChange={e=>setF({...f,package_addon_subline:e.target.value})} placeholder="Erweiterungsbox: Hauptsatz"/><textarea className="input textarea" value={f.package_addon_note||''} onChange={e=>setF({...f,package_addon_note:e.target.value})} placeholder="Hinweis: alle Funktionen zubuchbar"/><input className="input" value={f.package_addon_cta_label||''} onChange={e=>setF({...f,package_addon_cta_label:e.target.value})} placeholder="Buttontext der Erweiterungsbox"/></div><div><input className="input" value={f.optional_tools_headline||''} onChange={e=>setF({...f,optional_tools_headline:e.target.value})} placeholder="Überschrift optionaler Tools"/><textarea className="input textarea" value={f.optional_tools_subline||''} onChange={e=>setF({...f,optional_tools_subline:e.target.value})} placeholder="Beschreibung optionaler Tools"/><div className="sub">Optional zubuchbare Tool-Chips:</div>{optionalToolList().map((tool:any,i:number)=><div className="toolEditRow" key={`${tool}-${i}`}><input className="input" value={tool||''} onChange={e=>patchOptionalTool(i,e.target.value)} placeholder={`Tool ${i+1}`}/><button className="btn secondary" onClick={()=>removeOptionalTool(i)}>−</button></div>)}<button className="btn secondary" onClick={addOptionalTool}>Tool hinzufügen</button></div></div><div className="toolbarActions"><button className="btn" onClick={save}>Änderungen speichern</button><button className="btn secondary" onClick={reset}>Standardtexte laden</button><button className="btn secondary" onClick={()=>{setF(mainLandingSettings(store.data));window.open('/', '_blank')}}>Öffentliche Seite öffnen</button></div></Card>
 </>
}
...
function LandingTextEditor({store,q}:any){
 ...
 const initialLandingForm=()=>({
  ...
  headline:(q.metadata||{}).hero_headline||q.headline||'Willkommen im Bonusclub',
  subline:(q.metadata||{}).hero_subline||'Sammle Punkte, sichere dir Prämien und werde VIP.',
  cta_label:(q.metadata||{}).cta_label||'Punkte sammeln',
  review_cta_label:(q.metadata||{}).review_cta_label||'Bewertung absenden',
  success_title:(q.metadata||{}).success_title||'Deine Punkte wurden gespeichert.',
  success_message:(q.metadata||{}).success_message||'Danke für deine Teilnahme. Deine Vorteile werden direkt deinem Bonuskonto zugeordnet.',
  fineprint:(q.metadata||{}).fineprint||'Mit dem Absenden nimmst du am digitalen Bonusprogramm teil.',
  points_per_scan:Number(q.points_per_scan ?? (q.metadata||{}).points_per_scan ?? 10),
  max_scans_per_member:Number(q.max_scans_per_member ?? (q.metadata||{}).max_scans_per_member ?? 0),
  daily_scan_limit_per_member:Number(q.daily_scan_limit_per_member ?? (q.metadata||{}).daily_scan_limit_per_member ?? (q.metadata||{}).daily_scan_limit ?? 0),
  scan_cooldown_minutes:Number(q.scan_cooldown_minutes ?? (q.metadata||{}).scan_cooldown_minutes ?? 0),
  daily_point_limit_per_member:Number(q.daily_point_limit_per_member ?? (q.metadata||{}).daily_point_limit_per_member ?? 0),
  suspicion_score_threshold:Number(q.suspicion_score_threshold ?? (q.metadata||{}).suspicion_score_threshold ?? 70),
  redemption_mode:(q.metadata||{}).redemption_mode||'customer_phone_staff_pin',
  show_staff_pin_on_counter:(q.metadata||{}).show_staff_pin_on_counter===true,
  redemption_code_ttl_minutes:Number((q.metadata||{}).redemption_code_ttl_minutes||240),
  loyalty_display_mode:(q.metadata||{}).loyalty_display_mode||'classic',
  stamp_card_slots:Number((q.metadata||{}).stamp_card_slots||10),
  stamp_card_reward_text:(q.metadata||{}).stamp_card_reward_text||'Volle Karte = Prämie sichern',
  stamp_card_stamp_style:(q.metadata||{}).stamp_card_stamp_style||'logo',
  stamp_card_show_logo:(q.metadata||{}).stamp_card_show_logo!==false,
  stamp_card_logo_url:(q.metadata||{}).stamp_card_logo_url||(q.metadata||{}).stamp_card_background||(q.metadata||{}).brand_logo_url||'',
  stamp_card_background:(q.metadata||{}).stamp_card_background||'',
  points_per_stamp:Number((q.metadata||{}).points_per_stamp||(q.metadata||{}).points_per_scan||q.points_per_scan||10)
 })
 const [f,setF]=useState<any>(initialLandingForm())
 const [rewardForm,setRewardForm]=useState<any>({name:'',required_points:50,reward_type:'free_item',description:''})
 const [uploadingStampLogo,setUploadingStampLogo]=useState(false)
 useEffect(()=>{setF(initialLandingForm())},[q.id,q.updated_at,JSON.stringify(q.metadata||{})])
 function patch(k:string,v:any){setF((p:any)=>({...p,[k]:v}))}
 async function uploadStampCardLogo(file:File|null){
  if(!file) return
  const type=String(file.type||'').toLowerCase()
  if(!['image/png','image/jpeg','image/jpg','image/webp'].includes(type)) { appToast('Bitte PNG, JPG oder WEBP hochladen.'); return }
  if(file.size>5*1024*1024){ appToast('Das Logo darf maximal 5 MB groß sein.'); return }
  try{
   setUploadingStampLogo(true)
   const fd=new FormData()
   fd.append('file',file)
   const r:any=await apiRequest(`${API_BASE}/api/v33-functional/qr-campaigns/${q.id}/stamp-logo`,{method:'POST',body:fd,expectJson:false,timeoutMs:30000})
   const url=r?.stamp_card_logo_url||r?.data?.stamp_card_logo_url||r?.qr_campaign?.metadata?.stamp_card_logo_url||''
   if(!url) throw new Error('Es wurde keine Bild-URL zurückgegeben.')
   setF((prev:any)=>({...prev,stamp_card_logo_url:url,stamp_card_show_logo:true}))
   if(r?.qr_campaign){store.setData?.((prev:any)=>({...prev,qr_campaigns:safeList(prev.qr_campaigns).map((row:any)=>String(row.id)===String(q.id)?{...row,...r.qr_campaign}:row)}))}
   setMsg('Stempel-Logo hochgeladen. Bitte die QR-Zielseite noch speichern.')
   appToast('Stempel-Logo hochgeladen')
  }catch(e:any){
   appToast(e?.message||'Logo-Upload fehlgeschlagen')
   setMsg(e?.message||'Logo-Upload fehlgeschlagen')
  }finally{setUploadingStampLogo(false)}
 }
 function normalizedPayload(){
  ...
  return {
   ...
   redemption_mode:f.redemption_mode||'customer_phone_staff_pin',
   show_staff_pin_on_counter:f.show_staff_pin_on_counter===true,
   redemption_code_ttl_minutes:toNumber(f.redemption_code_ttl_minutes,240),
   loyalty_display_mode:['classic','stamp_card','hybrid'].includes(String(f.loyalty_display_mode||''))?String(f.loyalty_display_mode):'classic',
   stamp_card_slots:[6,8,10,12].includes(Number(f.stamp_card_slots))?Number(f.stamp_card_slots):10,
   stamp_card_reward_text:f.stamp_card_reward_text||'Volle Karte = Prämie sichern',
   stamp_card_stamp_style:['logo','check','star'].includes(String(f.stamp_card_stamp_style||''))?String(f.stamp_card_stamp_style):'logo',
   stamp_card_show_logo:f.stamp_card_show_logo!==false,
   stamp_card_logo_url:f.stamp_card_logo_url||'',
   stamp_card_background:f.stamp_card_background||'',
   points_per_stamp:Math.max(1,toNumber(f.points_per_stamp,10)),
 ...
 async function save(){
  ...
  const nextMetadata={...md,hero_headline:payload.headline,hero_subline:payload.subline,cta_label:payload.cta_label,review_cta_label:payload.review_cta_label,success_title:payload.success_title,success_message:payload.success_message,fineprint:payload.fineprint,points_per_scan:payload.points_per_scan,max_scans_per_member:payload.max_scans_per_member,daily_scan_limit_per_member:payload.daily_scan_limit_per_member,scan_cooldown_minutes:payload.scan_cooldown_minutes,daily_point_limit_per_member:payload.daily_point_limit_per_member,suspicion_score_threshold:payload.suspicion_score_threshold,redemption_mode:payload.redemption_mode,show_staff_pin_on_counter:payload.show_staff_pin_on_counter,redemption_code_ttl_minutes:payload.redemption_code_ttl_minutes,loyalty_display_mode:payload.loyalty_display_mode,stamp_card_slots:payload.stamp_card_slots,stamp_card_reward_text:payload.stamp_card_reward_text,stamp_card_stamp_style:payload.stamp_card_stamp_style,stamp_card_show_logo:payload.stamp_card_show_logo,stamp_card_logo_url:payload.stamp_card_logo_url,stamp_card_background:payload.stamp_card_background,points_per_stamp:payload.points_per_stamp,final_slug_rules_source:'qr_campaigns'}
  try{
   const saved=await v33FunctionalClient.saveFinalSlugSettings(q.id,payload)
   const updated=saved?.qr_campaign||{...q,title:payload.title,name:payload.title,headline:payload.headline,metadata:nextMetadata,points_per_scan:payload.points_per_scan,max_scans_per_member:payload.max_scans_per_member,daily_scan_limit_per_member:payload.daily_scan_limit_per_member,scan_cooldown_minutes:payload.scan_cooldown_minutes,daily_point_limit_per_member:payload.daily_point_limit_per_member,suspicion_score_threshold:payload.suspicion_score_threshold}
   store.setData?.((prev:any)=>({...prev,qr_campaigns:safeList(prev.qr_campaigns).map((row:any)=>String(row.id)===String(q.id)?{...row,...updated}:row)}))
   await store.load?.()
   setMsg('QR-Zielseiten-Einstellungen gespeichert. Diese Werte sind jetzt die einzige maßgebliche Quelle für Punkte, Limits und öffentliche Texte.')
  }catch(e:any){
   try{
    await store.update('qr_campaigns',q.id,{title:payload.title,name:payload.title,headline:payload.headline,points_per_scan:payload.points_per_scan,max_scans_per_member:payload.max_scans_per_member,daily_scan_limit_per_member:payload.daily_scan_limit_per_member,scan_cooldown_minutes:payload.scan_cooldown_minutes,daily_point_limit_per_member:payload.daily_point_limit_per_member,suspicion_score_threshold:payload.suspicion_score_threshold,metadata:nextMetadata})
    await store.load?.()
    setMsg('QR-Zielseiten-Einstellungen wurden direkt in qr_campaigns gespeichert.')
 ...
 const rewardTitle=(r:any)=>r.title||r.name||r.label||r.reward_title||r.reward_name||r.description||'Prämie'
 const belongsToThisQr=(r:any)=>String(r.qr_campaign_id||'')===String(q.id)||String(r.loyalty_program_id||'')===String(q.loyalty_program_id||'')||String(r.metadata?.qr_slug||'')===String(q.slug||'')
 const rewards=safeList(store.data.loyalty_rewards).filter((r:any)=>String(r.customer_id||'')===String(q.customer_id||'')&&belongsToThisQr(r)&&r.active!==false&&!['deleted','archived','gelöscht','geloescht'].includes(String(r.status||'').toLowerCase()))
 async function saveReward(){
  const row={customer_id:q.customer_id,qr_campaign_id:q.id,loyalty_program_id:q.loyalty_program_id||null,name:rewardForm.name||'Neue Prämie',title:rewardForm.name||'Neue Prämie',description:rewardForm.description||'',required_points:Number(rewardForm.required_points||0),points:Number(rewardForm.required_points||0),reward_type:rewardForm.reward_type||'free_item',active:true,status:'active',metadata:{qr_slug:q.slug,source:'qr_zielseite'}}
  await store.create('loyalty_rewards',row); setRewardForm({name:'',required_points:50,reward_type:'free_item',description:''}); await store.load?.(); setMsg('Prämie wurde dieser QR-Zielseite zugeordnet.')
 }
 async function deleteReward(r:any){
  await store.update('loyalty_rewards',r.id,{active:false,status:'deleted',deleted_at:new Date().toISOString(),metadata:{...(r.metadata||{}),deleted_from:'qr_zielseite'}}); await store.load?.(); setMsg('Prämie wurde gelöscht und erscheint nicht mehr öffentlich.')
 }
 return <div className="v42PackageEdit finalSlugRules"><div className="item"><div><b>Finale Einstellungen für diese öffentliche QR-Zielseite</b><div className="sub">Diese Werte werden an <code>qr_campaigns</code> gespeichert und sind die maßgebliche Quelle für <code>/l/{q.slug}</code>. Andere Punkteprogramm-/Security-Felder dienen nur noch als Fallback, wenn hier kein Kampagnenwert vorhanden ist.</div></div><Badge type="green">final</Badge></div><input className="input" value={f.title} onChange={e=>patch('title',e.target.value)} placeholder="Interner Seitentitel" title="Interner Name der Slug-/QR-Kampagne im Adminbereich"/><input className="input" value={f.headline} onChange={e=>patch('headline',e.target.value)} placeholder="Öffentliche Headline auf der QR-Zielseite" title="Diese Überschrift sieht der Endkunde oben auf der öffentlichen QR-Zielseite"/><textarea className="input textarea" value={f.subline} onChange={e=>patch('subline',e.target.value)} placeholder="Unterzeile / Erklärung auf der QR-Zielseite" title="Kurz erklären, warum der Endkunde Punkte sammelt oder eine Bewertung abgibt"/><div className="grid2"><input className="input" value={f.cta_label} onChange={e=>patch('cta_label',e.target.value)} placeholder="Button-Text für Punkteprogramm, z. B. Punkte sammeln" title="Text auf dem Sammeln-Button"/><input className="input" value={f.review_cta_label} onChange={e=>patch('review_cta_label',e.target.value)} placeholder="Button-Text für Review, z. B. Bewertung absenden" title="Text auf dem Bewertungs-Button"/></div><input className="input" value={f.success_title} onChange={e=>patch('success_title',e.target.value)} placeholder="Erfolgsüberschrift nach Scan/Absenden" title="Überschrift nach erfolgreichem Speichern"/><textarea className="input textarea" value={f.success_message} onChange={e=>patch('success_message',e.target.value)} placeholder="Erfolgstext nach Scan/Absenden" title="Text nach erfolgreicher Punktevergabe oder Bewertung"/><textarea className="input textarea" value={f.fineprint} onChange={e=>patch('fineprint',e.target.value)} placeholder="Rechtlicher Hinweis / Kleingedrucktes" title="Hinweis unter dem Formular der öffentlichen QR-Zielseite"/><div className="ruleBox"><b>Stempelkarten-Ansicht auf der QR-Zielseite</b><div className="sub">Wähle hier, ob die öffentliche Slugseite als klassische Punkteansicht, digitale Stempelkarte oder kombiniert angezeigt wird. Die Stempelkarte ist nur Visualisierung; Punkte werden weiter serverseitig vergeben.</div><div className="grid2 mini"><label className="formField"><span>Darstellung</span><select className="input" value={f.loyalty_display_mode} onChange={e=>patch('loyalty_display_mode',e.target.value)}><option value="classic">Punkteansicht</option><option value="stamp_card">Stempelkarte</option><option value="hybrid">Kombiniert</option></select>{help('Sichtbar unter /l/[slug]','Die bisherige Ansicht bleibt bei „Punkteansicht“ unverändert.')}</label><label className="formField"><span>Anzahl Stempelfelder</span><select className="input" value={Number(f.stamp_card_slots)||10} onChange={e=>patch('stamp_card_slots',Number(e.target.value))}><option value={6}>6 Stempelfelder</option><option value={8}>8 Stempelfelder</option><option value={10}>10 Stempelfelder</option><option value={12}>12 Stempelfelder</option></select>{help('Empfohlen','10 Felder für Café/Bäcker, 8 Felder für schnelle Aktionen.')}</label></div><div className="grid2 mini"><label className="formField"><span>Stempelstil</span><select className="input" value={f.stamp_card_stamp_style||'logo'} onChange={e=>patch('stamp_card_stamp_style',e.target.value)}><option value="logo">Kundenlogo</option><option value="check">Haken</option><option value="star">Stern</option></select>{help('Fallback','Ohne Logo wird automatisch Haken/Stern genutzt.')}</label><label className="formField"><span>Punkte pro Stempel</span><input className="input" type="number" min="1" value={Number(f.points_per_stamp)||10} onChange={e=>patch('points_per_stamp',Math.max(1,Number(e.target.value)||10))}/>{help('Logik','1 Besuch kann z. B. 1 Punkt = 1 Stempel sein; bei 10 Punkten pro Scan entsprechend 10.')}</label></div><label className="checkRow"><input type="checkbox" checked={f.stamp_card_show_logo!==false} onChange={e=>patch('stamp_card_show_logo',e.target.checked)}/><span>Kundenlogo als Stempel verwenden, wenn ein Logo hinterlegt ist</span></label><input className="input" value={f.stamp_card_reward_text||''} onChange={e=>patch('stamp_card_reward_text',e.target.value)} placeholder="Belohnungstext, z. B. 10 Stempel = 1 Kaffee gratis"/><div className="grid2 mini"><label className="formField"><span>Stempel-Logo als Bild hochladen</span><input className="input" type="file" accept="image/png,image/jpeg,image/jpg,image/webp" onChange={e=>uploadStampCardLogo(e.target.files?.[0]||null)}/><div className="fieldHelp">PNG oder JPG hochladen. Das Bild wird direkt als Stempel auf der Karte verwendet.</div></label><label className="formField"><span>Stempel-Logo per URL (optional)</span><input className="input" value={f.stamp_card_logo_url||''} onChange={e=>patch('stamp_card_logo_url',e.target.value)} placeholder="https://.../logo.png"/><div className="fieldHelp">Empfohlen ist der Upload. Externe URLs werden serverseitig begrenzt; Kunden sollten hier nur MMOS-/Supabase-URLs nutzen.</div></label></div>{f.stamp_card_logo_url&&<div className="item"><div><b>Aktuelles Stempel-Logo</b><div className="sub">Dieses Logo wird in gefüllten Stempelfeldern verwendet.</div></div><img src={f.stamp_card_logo_url} alt="Stempel-Logo Vorschau" style={{width:56,height:56,objectFit:'contain',borderRadius:14,background:'rgba(255,255,255,.9)',padding:8,border:'1px solid rgba(255,255,255,.12)'}}/></div>}<input className="input" value={f.stamp_card_background||''} onChange={e=>patch('stamp_card_background',e.target.value)} placeholder="Optionaler Hintergrund / zusätzliche Bild-URL"/><div className="sub">{uploadingStampLogo?'Logo wird hochgeladen... ':'Die Einstellungen werden direkt in der QR-Kampagne gespeichert und von der öffentlichen /l/{q.slug}-Seite gelesen.'}</div></div><div className="ruleBox"><b>Finale Punkte- und Einlöse-Regeln</b><div className="sub">0 bedeutet bei Limits: kein Limit / unbegrenzt. Diese Felder ändern die echte Scan-Logik der öffentlichen QR-Zielseite.</div><div className="grid2 mini"><label className="formField"><span>Punkte pro gültigem Scan</span><input className="input" type="number" min="0" value={f.points_per_scan} onChange={e=>patch('points_per_scan',Number(e.target.value))} title="Wie viele Punkte nach einem gültigen Scan oder einer erfolgreichen Aktion vergeben werden"/>{help('Beispiel','1 = ein Punkt pro gültiger Aktion')}</label><label className="formField"><span>Max. Einlösungen insgesamt pro Endkunde</span><input className="input" type="number" min="0" value={f.max_scans_per_member} onChange={e=>patch('max_scans_per_member',Number(e.target.value))} title="Gesamtlimit pro Bonuskonto für diesen QR-Code. 0 bedeutet unbegrenzt."/>{help('Beispiel','1 = nur einmal insgesamt, 0 = kein Gesamtlimit')}</label></div><div className="grid2 mini"><label className="formField"><span>Max. Einlösungen pro Tag</span><input className="input" type="number" min="0" value={f.daily_scan_limit_per_member} onChange={e=>patch('daily_scan_limit_per_member',Number(e.target.value))} title="Tageslimit gültiger QR-Einlösungen pro Bonuskonto für genau diese QR-Zielseite. 0 bedeutet kein Tageslimit."/>{help('Beispiel','1 = einmal täglich, 3 = dreimal täglich, 0 = unbegrenzt')}</label><label className="formField"><span>Wartezeit zwischen Scans in Minuten</span><input className="input" type="number" min="0" value={f.scan_cooldown_minutes} onChange={e=>patch('scan_cooldown_minutes',Number(e.target.value))} title="Mindestabstand zwischen zwei gültigen Scans desselben Endkunden. 1440 = 24 Stunden."/>{help('Beispiel','1440 = erst nach 24 Stunden wieder gültig')}</label></div><div className="grid2 mini"><label className="formField"><span>Punkte-Tageslimit pro Endkunde</span><input className="input" type="number" min="0" value={f.daily_point_limit_per_member} onChange={e=>patch('daily_point_limit_per_member',Number(e.target.value))} title="Maximale Punkte pro Tag für diesen Endkunden. 0 bedeutet kein Punktelimit."/>{help('Beispiel','1 = maximal ein Punkt pro Tag')}</label><label className="formField"><span>Auffällig ab Verdachts-Score</span><input className="input" type="number" min="0" max="100" value={f.suspicion_score_threshold} onChange={e=>patch('suspicion_score_threshold',Number(e.target.value))} title="Ab diesem Score erscheint der Endkunde im Security Center als auffällig."/>{help('Empfohlen','70 auf einer Skala von 0 bis 100')}</label></div></div><div className="ruleBox"><b>Tresenmodus & Einlösung vor Ort</b><div className="sub">Wähle, wie Prämien im Café/Imbiss eingelöst werden: Mitarbeiter-PIN direkt auf dem Kundenhandy oder Kundencode im Tresenmodus.</div><div className="grid2 mini"><label className="formField"><span>Einlösemodus</span><select className="input" value={f.redemption_mode} onChange={e=>patch('redemption_mode',e.target.value)}><option value="customer_phone_staff_pin">Mitarbeiter tippt PIN auf Kundenhandy ein</option><option value="counter_customer_code">Kunde zeigt Code, Mitarbeiter löst im Tresenmodus ein</option></select>{help('Empfehlung','Café/Imbiss: Tresenmodus mit Kundencode. Kleiner Betrieb: Mitarbeiter-PIN auf Kundenhandy.')}</label><label className="formField"><span>Code gültig in Minuten</span><input className="input" type="number" min="15" value={f.redemption_code_ttl_minutes} onChange={e=>patch('redemption_code_ttl_minutes',Number(e.target.value))}/>{help('Standard','240 Minuten, damit der Code für denselben Besuch nutzbar bleibt.')}</label></div><label className="checkRow"><input type="checkbox" checked={f.show_staff_pin_on_counter===true} onChange={e=>patch('show_staff_pin_on_counter',e.target.checked)}/><span>Mitarbeiter-PIN im Tresenmodus nur anzeigen, wenn bewusst aktiviert</span></label><div className="toolbarActions"><button className="btn secondary" onClick={()=>window.open(`/counter/${q.slug}`,'_blank')}>Tresenmodus öffnen</button><button className="btn secondary" onClick={()=>window.open(`/qr-display/${q.slug}`,'_blank')}>Live-QR Anzeige öffnen</button></div></div><div className="ruleBox"><b>Prämien dieser QR-Zielseite</b><div className="sub">Prämien werden nur noch hier pro QR-Zielseite gepflegt. Alte Prämien anderer Kampagnen werden nicht mehr öffentlich angezeigt.</div>{rewards.length===0&&<div className="sub">Noch keine aktive Prämie für diese QR-Zielseite.</div>}{rewards.map((r:any)=><div className="item" key={r.id}><div><b>{rewardTitle(r)}</b><div className="sub">{Number(r.required_points||r.points||0)} Punkte · {r.reward_type||'Prämie'}</div></div><button className="btn secondary" onClick={()=>deleteReward(r)}>Löschen</button></div>)}<div className="grid4"><input className="input" value={rewardForm.name} onChange={e=>setRewardForm({...rewardForm,name:e.target.value})} placeholder="Prämienname"/><input className="input" type="number" min="0" value={rewardForm.required_points} onChange={e=>setRewardForm({...rewardForm,required_points:Number(e.target.value)})} placeholder="Benötigte Punkte"/><input className="input" value={rewardForm.reward_type} onChange={e=>setRewardForm({...rewardForm,reward_type:e.target.value})} placeholder="Typ"/><button className="btn secondary" onClick={saveReward}>Prämie hinzufügen</button></div><textarea className="input textarea" value={rewardForm.description} onChange={e=>setRewardForm({...rewardForm,description:e.target.value})} placeholder="Beschreibung der Prämie"/></div><Card title="QR-Ausgabe & Druck"><div className="sub">PNG herunterladen, Druckvorlage öffnen oder die Live-Anzeige für rotierende QR-Codes starten. Wenn „nach jedem Scan neuer QR“ aktiv ist, aktualisiert die QR-Anzeige automatisch auf den neuen Code.</div><V36QrExport slug={q.slug} title={q.title||q.name||'Scanne & Punkte sammeln'} customerName={cname(store.data,q.customer_id)}/></Card><div className="toolbarActions"><button className="btn" onClick={save} disabled={busy}>{busy?'Speichert...':'QR-Zielseite speichern'}</button><button className="btn secondary" onClick={()=>window.open(`/l/${q.slug}`,'_blank')}>Live ansehen</button><button className="btn secondary" onClick={()=>window.open(`/qr-display/${q.slug}`,'_blank')}>QR-Anzeige öffnen</button></div>{msg&&<div className="sub">{msg}</div>}</div>
}


function ReactivationPanel({store,q}:any){
 const cid=q.customer_id
 const qrId=q.id
 const accessKeys=safeList(store.data.customer_tool_access).filter((x:any)=>String(x.customer_id||'')===String(cid)&&x.enabled!==false).map((x:any)=>String(x.tool_key||x.tool||'').trim().toLowerCase())
 const enabled=accessKeys.some((k:string)=>['rückholaktionen','rueckholaktionen','customer_reactivation','reactivation','inactive_customer_reactivation'].includes(k))
 const setting=safeList(store.data.customer_reactivation_settings).find((x:any)=>String(x.qr_campaign_id||'')===String(qrId))||safeList(store.data.customer_reactivation_settings).find((x:any)=>String(x.customer_id||'')===String(cid))||null
 const customer=cobj(store.data,cid)||{}
 const defaultEmailBody=['Hallo {vorname},','','wir haben dich bei {betrieb} vermisst. Als kleines Dankeschön wartet diese persönliche Rückhol-Prämie auf dich:','','{praemie}','','Öffne deinen persönlichen Einmal-Link:','{rueckhol_link}','','Gültig bis: {gueltig_bis}','{einloese_hinweis}'].join('\n')
 const defaultReminderBody=['Hallo {vorname},','','deine persönliche Rückhol-Prämie bei {betrieb} wartet noch auf dich:','','{praemie}','','Hier kannst du sie öffnen:','{rueckhol_link}','','{einloese_hinweis}'].join('\n')
 const defaultForm={
  active:setting?.active!==false,
  inactive_after_days:Number(setting?.inactive_after_days||30),
  reward_name:setting?.reward_name||'Wir vermissen dich: Gratis Kaffee',
  reward_type:setting?.reward_type||'free_item',
  reward_points:Number(setting?.reward_points||20),
  valid_days:Number(setting?.valid_days||14),
  staff_code_required:setting?.staff_code_required!==false,
  email_subject:setting?.email_subject||'Wir haben dich vermisst, {vorname} ☕',
  email_intro:setting?.email_intro||'Komm wieder vorbei und sichere dir deine persönliche Rückhol-Prämie.',
  email_body_template:setting?.email_body_template||setting?.metadata?.email_body_template||setting?.email_intro||defaultEmailBody,
  email_button_label:setting?.email_button_label||setting?.metadata?.email_button_label||'Rückhol-Prämie öffnen',
  email_signature:setting?.email_signature||setting?.metadata?.email_signature||'Liebe Grüße\n{betrieb}',
  email_automation_enabled:setting?.email_automation_enabled===true,
  require_marketing_consent:true,
  reminder_enabled:setting?.reminder_enabled!==false,
  reminder_after_days:Number(setting?.reminder_after_days||3),
  reminder_max_count:Number(setting?.reminder_max_count||1),
  reminder_subject:setting?.reminder_subject||'Erinnerung: Deine Rückhol-Prämie wartet noch',
  reminder_intro:setting?.reminder_intro||'Deine persönliche Rückhol-Prämie ist noch verfügbar.',
  reminder_body_template:setting?.reminder_body_template||setting?.metadata?.reminder_body_template||setting?.reminder_intro||defaultReminderBody,
  reminder_button_label:setting?.reminder_button_label||setting?.metadata?.reminder_button_label||'Prämie jetzt öffnen'
 }
 ...
 useEffect(()=>{setF(defaultForm)},[setting?.id,setting?.updated_at,qrId])
 function patch(k:string,v:any){setF((p:any)=>({...p,[k]:v}))}
 const members=safeList(store.data.loyalty_customers).filter((m:any)=>String(m.customer_id||'')===String(cid)&&(!q.loyalty_program_id||String(m.loyalty_program_id||'')===String(q.loyalty_program_id)))
 const tx=safeList(store.data.loyalty_transactions).filter((t:any)=>String(t.customer_id||'')===String(cid))
 function lastSeen(m:any){const ownTx=tx.filter((t:any)=>String(t.loyalty_customer_id||'')===String(m.id)).sort((a:any,b:any)=>String(b.created_at).localeCompare(String(a.created_at)))[0];return m.last_seen_at||m.last_activity_at||ownTx?.created_at||m.created_at}
 function hasMailConsent(m:any){const meta=m.metadata||{};const ev=meta.marketing_consent||{};const purposes=[...(Array.isArray(ev.purposes)?ev.purposes:[]),...(Array.isArray(meta.marketing_consent_purposes)?meta.marketing_consent_purposes:[])].map((v:any)=>String(v||'').toLowerCase());const text=String(ev.text||meta.marketing_consent_text||'').toLowerCase();const granted=m.marketing_consent_status==='granted'||meta.marketing_consent_status==='granted'||ev.status==='granted';const reactivation=purposes.includes('reactivation')||text.includes('reaktivierung')||text.includes('reaktivierungsaktion');return !!(granted&&reactivation)}
 const cutoff=Date.now()-Number(f.inactive_after_days||30)*86400000
 ...
 const bounced=links.filter((l:any)=>String(l.email_status||'').toLowerCase()==='bounced'||l.bounced_at).length
 ...
 async function saveSettings(){
  const payload={customer_id:cid,qr_campaign_id:qrId,active:!!f.active,inactive_after_days:Number(f.inactive_after_days||30),reward_name:f.reward_name,reward_type:f.reward_type,reward_points:Number(f.reward_points||0),valid_days:Number(f.valid_days||14),staff_code_required:f.staff_code_required!==false,email_subject:f.email_subject,email_intro:f.email_intro||f.email_body_template,email_body_template:f.email_body_template,email_button_label:f.email_button_label,email_signature:f.email_signature,email_from:'MecklenburgMarketing Loyalty <loyalty@mecklenburgmarketing.de>',email_automation_enabled:!!f.email_automation_enabled,require_marketing_consent:true,reminder_enabled:f.reminder_enabled!==false,reminder_after_days:Number(f.reminder_after_days||3),reminder_max_count:Number(f.reminder_max_count||1),reminder_subject:f.reminder_subject,reminder_intro:f.reminder_intro||f.reminder_body_template,reminder_body_template:f.reminder_body_template,reminder_button_label:f.reminder_button_label,metadata:{source:'qr_zielseite',slug:q.slug,mail_from:'loyalty@mecklenburgmarketing.de',consent_basis:'slug_double_opt_in_reactivation',template_version:'v093_customer_editable_reactivation_mail',allowed_placeholders:placeholders},updated_at:new Date().toISOString()}
  if(setting?.id) await store.update('customer_reactivation_settings',setting.id,payload); else await store.create('customer_reactivation_settings',payload)
  await store.load?.(); setMsg('Rückholaktion und E-Mail-Vorlagen gespeichert.')
 }
 function token(){return `rh_${Math.random().toString(36).slice(2)}${Date.now().toString(36)}`}
 function linkUrl(l:any){return `${typeof window!=='undefined'?window.location.origin:''}/reactivate/${l.token||l.recovery_token}`}
 async function createLinks(){
  await saveSettings(); let created=0
  for(const m of inactive){
   const email=String(m.email||'').trim(); if(!email) continue
   if(!hasMailConsent(m)) continue
   const existing=links.find((l:any)=>String(l.loyalty_customer_id||'')===String(m.id)&&['open','sent','opened'].includes(String(l.status||'open').toLowerCase()))
   if(existing) continue
   await store.create('customer_reactivation_links',{customer_id:cid,qr_campaign_id:qrId,loyalty_customer_id:m.id,loyalty_program_id:q.loyalty_program_id||m.loyalty_program_id||null,email,display_name:m.display_name||m.name||email.split('@')[0],token:token(),status:'open',email_status:'created',reward_name:f.reward_name,reward_type:f.reward_type,reward_points:Number(f.reward_points||0),staff_code_required:f.staff_code_required!==false,expires_at:new Date(Date.now()+Number(f.valid_days||14)*86400000).toISOString(),reminder_count:0,metadata:{slug:q.slug,inactive_after_days:Number(f.inactive_after_days||30),last_seen_at:lastSeen(m),email_subject:f.email_subject,email_template_snapshot:f.email_body_template,mail_from:'loyalty@mecklenburgmarketing.de'},created_at:new Date().toISOString(),updated_at:new Date().toISOString()})
   created++
  }
  await store.load?.(); setMsg(created?`${created} persönliche Rückhol-Link(s) erstellt.`:`Keine neuen Links erstellt. ${skippedNoConsent?`${skippedNoConsent} Kontakt(e) ohne bestätigte Werbeeinwilligung übersprungen.`:'Entweder keine inaktiven Kunden mit E-Mail oder Links existieren bereits.'}`)
 }
 async function sendAll(){
  setBusyMail(true); setMailMsg('')
  try{await saveSettings(); const r:any=await v33FunctionalClient.sendReactivationMails(cid,qrId,{limit:100}); await store.load?.(); setMailMsg(`E-Mails: ${r?.counts?.sent||0} gesendet, ${r?.counts?.skipped||0} übersprungen, ${r?.counts?.failed||0} fehlgeschlagen.`)}catch(e:any){setMailMsg(e.message||'E-Mail-Versand fehlgeschlagen.')}finally{setBusyMail(false)}
 }
 async function sendReminders(){
  setBusyMail(true); setMailMsg('')
  try{await saveSettings(); const r:any=await v33FunctionalClient.sendReactivationReminders(cid,qrId,{limit:100}); await store.load?.(); setMailMsg(`Reminder: ${r?.counts?.sent||0} gesendet, ${r?.counts?.skipped||0} übersprungen, ${r?.counts?.failed||0} fehlgeschlagen.`)}catch(e:any){setMailMsg(e.message||'Reminder-Versand fehlgeschlagen.')}finally{setBusyMail(false)}
 }
 ...
 return <Card title="Rückholaktionen" action={<Badge type="green">zubuchbar aktiv</Badge>}>
  <div className="sub">Persönliche Einmal-Links per E-Mail von <b>loyalty@mecklenburgmarketing.de</b>. Öffnung, Zustellung/Bounce, Einlösung und Reaktivierung werden getrennt getrackt. Erfolg zählt erst mit Mitarbeitercode.</div>
  <div className="grid4"><Metric label="Inaktive Kunden" value={inactive.length}/><Metric label="Mailfähig" value={inactiveWithMail.length}/><Metric label="E-Mails gesendet" value={sentLinks.length}/><Metric label="Reaktiviert" value={redeemed.length}/></div>
  <div className="grid4"><Metric label="Geöffnet" value={opened}/><Metric label="Zugestellt" value={delivered}/><Metric label="Bounces" value={bounced}/><Metric label="Links offen" value={openLinks.length}/></div>
  <div className="grid2"><label className="formField"><span>Inaktiv nach Tagen</span><input className="input" type="number" min="1" value={f.inactive_after_days} onChange={e=>patch('inactive_after_days',Number(e.target.value))}/></label><label className="formField"><span>Link gültig in Tagen</span><input className="input" type="number" min="1" value={f.valid_days} onChange={e=>patch('valid_days',Number(e.target.value))}/></label></div>
  <input className="input" value={f.reward_name} onChange={e=>patch('reward_name',e.target.value)} placeholder="Rückhol-Prämie"/>
  <div className="grid2"><input className="input" value={f.reward_type} onChange={e=>patch('reward_type',e.target.value)} placeholder="Typ"/><input className="input" type="number" min="0" value={f.reward_points} onChange={e=>patch('reward_points',Number(e.target.value))} placeholder="Bonus-/Prämienpunkte"/></div>
  <div className="ruleBox"><b>Rückholmail-Editor</b><div className="sub">Der Betrieb kann Betreff, Text, Button und Signatur selbst anpassen. Pflichtfooter, Double-Opt-in-Hinweis und Abmeldelink bleiben fest im System.</div><div className="sub">Platzhalter: {placeholders.map(p=><code key={p}> {p} </code>)}</div><input className="input" value={f.email_subject} onChange={e=>patch('email_subject',e.target.value)} placeholder="E-Mail Betreff"/><textarea className="input textarea" value={f.email_body_template} onChange={e=>patch('email_body_template',e.target.value)} placeholder="E-Mail Text mit Platzhaltern"/><div className="grid2"><input className="input" value={f.email_button_label} onChange={e=>patch('email_button_label',e.target.value)} placeholder="Button-Text"/><textarea className="input textarea" value={f.email_signature} onChange={e=>patch('email_signature',e.target.value)} placeholder="Signatur"/></div><div className="ruleBox"><b>Vorschau Rückholmail</b><div className="sub"><b>Betreff:</b> {renderPreview(f.email_subject)}</div><pre className="sub" style={{whiteSpace:'pre-wrap'}}>{emailPreview}</pre><div className="sub"><b>Button:</b> {renderPreview(f.email_button_label)}</div><div className="sub">Pflichtfooter: Double-Opt-in-Hinweis + Abmeldelink werden automatisch ergänzt.</div></div><label className="checkRow"><input type="checkbox" checked disabled readOnly/><span>Pflicht: Rückholmails nur an Kontakte mit bestätigter Slug-Double-Opt-in-Einwilligung für persönliche Reaktivierungsaktionen</span></label><label className="checkRow"><input type="checkbox" checked={!!f.email_automation_enabled} onChange={e=>patch('email_automation_enabled',e.target.checked)}/><span>Automatische Rückhol-Mails für offene Links erlauben</span></label></div>
  <div className="ruleBox"><b>Reminder-Mail-Editor</b><div className="grid2"><label className="formField"><span>Reminder nach Tagen</span><input className="input" type="number" min="1" value={f.reminder_after_days} onChange={e=>patch('reminder_after_days',Number(e.target.value))}/></label><label className="formField"><span>Max. Reminder</span><input className="input" type="number" min="0" value={f.reminder_max_count} onChange={e=>patch('reminder_max_count',Number(e.target.value))}/></label></div><input className="input" value={f.reminder_subject} onChange={e=>patch('reminder_subject',e.target.value)} placeholder="Reminder-Betreff"/><textarea className="input textarea" value={f.reminder_body_template} onChange={e=>patch('reminder_body_template',e.target.value)} placeholder="Reminder-Text mit Platzhaltern"/><input className="input" value={f.reminder_button_label} onChange={e=>patch('reminder_button_label',e.target.value)} placeholder="Reminder Button-Text"/><div className="ruleBox"><b>Vorschau Reminder</b><div className="sub"><b>Betreff:</b> {renderPreview(f.reminder_subject)}</div><pre className="sub" style={{whiteSpace:'pre-wrap'}}>{reminderPreview}</pre><div className="sub"><b>Button:</b> {renderPreview(f.reminder_button_label)}</div></div><label className="checkRow"><input type="checkbox" checked={f.reminder_enabled!==false} onChange={e=>patch('reminder_enabled',e.target.checked)}/><span>Reminder-Sequenz aktiv</span></label></div>
  <label className="checkRow"><input type="checkbox" checked={f.staff_code_required!==false} onChange={e=>patch('staff_code_required',e.target.checked)}/><span>Einlösung nur mit Mitarbeitercode erlauben</span></label>
  <div className="toolbarActions"><button className="btn" onClick={saveSettings}>Einstellungen speichern</button><button className="btn secondary" onClick={createLinks}>Links erzeugen</button><button className="btn secondary" onClick={sendAll} disabled={busyMail}>Offene Links per E-Mail senden</button><button className="btn secondary" onClick={sendReminders} disabled={busyMail}>Reminder jetzt senden</button></div>
  <div className="grid2"><input className="input" value={testEmail} onChange={e=>setTestEmail(e.target.value)} placeholder="Test-E-Mail-Adresse"/><button className="btn secondary" onClick={sendTest} disabled={busyMail}>Testmail mit Vorschauinhalt senden</button></div>
  {mailMsg&&<div className="sub">{mailMsg}</div>}
  {links.length>0&&<div className="ruleBox"><b>Persönliche Links</b>{links.slice(0,12).map((l:any)=><div className="item" key={l.id}><div><b>{l.display_name||l.email}</b><div className="sub">{l.status||'open'} · Mail: {l.email_status||'–'} · Reminder: {Number(l.reminder_count||0)} · {l.reward_name||f.reward_name} · gültig bis {l.expires_at?new Date(l.expires_at).toLocaleDateString('de-DE'):'–'}</div><input className="input compactInput" readOnly value={linkUrl(l)}/></div><div className="toolbarActions"><button className="btn secondary" onClick={()=>navigator.clipboard?.writeText(linkUrl(l))}>Kopieren</button><button className="btn secondary" onClick={()=>markSent(l)}>Manuell versendet</button></div></div>)}</div>}
...
function customerToolEnabledLocal(data:any,cid:string,keys:string[]){
 const low=new Set(keys.map(k=>String(k||'').toLowerCase()))
 return safeList(data.customer_tool_access).some((x:any)=>String(x.customer_id||'')===String(cid)&&x.enabled!==false&&low.has(String(x.tool_key||x.tool||'').trim().toLowerCase()))
}
function memberHasReactivationConsentLocal(m:any){
 const meta=m?.metadata||{}
 const ev=meta.marketing_consent||{}
 const purposes=[...(Array.isArray(ev.purposes)?ev.purposes:[]),...(Array.isArray(meta.marketing_consent_purposes)?meta.marketing_consent_purposes:[])].map((v:any)=>String(v||'').toLowerCase())
 const text=String(ev.text||meta.marketing_consent_text||'').toLowerCase()
 const granted=m?.marketing_consent_status==='granted'||meta.marketing_consent_status==='granted'||ev.status==='granted'
 const reactivation=purposes.includes('reactivation')||text.includes('reaktivierung')||text.includes('reaktivierungsaktion')
 return !!(granted&&reactivation)
}
function localPilotReadiness(data:any,cid:string){
 const customer=cobj(data,cid)
 const qrs=safeList(data.qr_campaigns).filter((q:any)=>String(q.customer_id||'')===String(cid))
 const programs=safeList(data.loyalty_programs).filter((p:any)=>String(p.customer_id||'')===String(cid))
 const staff=safeList(data.staff_codes).filter((x:any)=>String(x.customer_id||'')===String(cid)&&x.active!==false&&!['inactive','gesperrt','archiviert'].includes(String(x.status||'').toLowerCase()))
 const rewards=safeList(data.loyalty_rewards).filter((x:any)=>String(x.customer_id||'')===String(cid)&&x.active!==false&&!['deleted','archiviert','inaktiv'].includes(String(x.status||'').toLowerCase()))
 const settings=safeList(data.customer_reactivation_settings).filter((x:any)=>String(x.customer_id||'')===String(cid)&&x.active!==false)
 const members=safeList(data.loyalty_customers).filter((m:any)=>String(m.customer_id||'')===String(cid))
 const links=safeList(data.customer_reactivation_links).filter((l:any)=>String(l.customer_id||'')===String(cid))
 const events=safeList(data.customer_reactivation_events).filter((e:any)=>String(e.customer_id||'')===String(cid))
 const mailEligible=members.filter((m:any)=>String(m.email||'').trim()&&memberHasReactivationConsentLocal(m)).length
 const reactivationTool=customerToolEnabledLocal(data,cid,['rückholaktionen','rueckholaktionen','customer_reactivation','reactivation','inactive_customer_reactivation'])
 const qrTool=customerToolEnabledLocal(data,cid,['qr kampagnen','qr_campaigns','qr','qr-kampagnen'])||qrs.length>0
 const loyaltyTool=customerToolEnabledLocal(data,cid,['loyalty','punkteprogramm','loyalty/punkteprogramm'])||programs.length>0
 const testEvents=links.filter((l:any)=>l?.metadata?.is_test_mail===true||String(l.email_status||'').startsWith('test')).length+events.filter((e:any)=>String(e.event_type||'').startsWith('test_')).length
 const checklist=[
  {key:'customer',label:'Kunde angelegt',ok:!!customer?.id,hint:customer?.name||customer?.company||'Kunde auswählen'},
  {key:'qr_tool',label:'QR-Kampagnen freigeschaltet / vorhanden',ok:!!qrTool,hint:qrs.length?`${qrs.length} QR-Kampagne(n)`:'QR freischalten'},
  {key:'loyalty_tool',label:'Loyalty/Punkteprogramm aktiv',ok:!!loyaltyTool,hint:programs.length?`${programs.length} Programm(e)`:'Loyalty freischalten'},
  {key:'reactivation_tool',label:'Rückholaktionen freigeschaltet',ok:!!reactivationTool,hint:reactivationTool?'Add-on aktiv':'Add-on freischalten'},
  {key:'qr_campaign',label:'QR-Zielseite angelegt',ok:qrs.length>0,hint:qrs[0]?.slug?`/q/${qrs[0].slug}`:'QR-Zielseite erstellen'},
  {key:'staff_code',label:'Mitarbeitercode aktiv',ok:staff.length>0,hint:staff.length?`${staff.length} Code(s)`:'Code anlegen'},
  {key:'reward',label:'Prämie/Rückholprämie vorhanden',ok:rewards.length>0||settings.length>0,hint:rewards.length?`${rewards.length} Prämie(n)`:'Prämie speichern'},
  {key:'reactivation_settings',label:'Rückholaktion konfiguriert',ok:settings.length>0,hint:settings.length?'Regel gespeichert':'Rückholtool speichern'},
  {key:'mail_consent',label:'Mailfähige Kontakte vorhanden',ok:mailEligible>0,hint:mailEligible?`${mailEligible} Double-Opt-in Kontakt(e)`:'Slug-Opt-in testen'},
  {key:'test_mail',label:'Testmail / Testlink geprüft',ok:testEvents>0,hint:testEvents?`${testEvents} Test-Ereignis(se)`:'Testmail senden'}
 ]
 const score=Math.round((checklist.filter(c=>c.ok).length/Math.max(1,checklist.length))*100)
 return {score,checklist,counts:{qr_campaigns:qrs.length,loyalty_programs:programs.length,loyalty_customers:members.length,mail_eligible:mailEligible,staff_codes:staff.length,rewards:rewards.length,reactivation_settings:settings.length,links:links.length,test_events:testEvents}}
}
function PilotChecklist({items}:any){return <div>{safeList(items).map((x:any)=><div className="item" key={x.key||x.label}><div><b>{x.label}</b><div className="sub">{x.hint||''}</div></div><Badge type={x.ok?'green':'yellow'}>{x.ok?'OK':'Offen'}</Badge></div>)}</div>}
function CustomerTodayQuickPanel({store,cid,setView}:any){
 const readiness=localPilotReadiness(store.data,cid)
 const qrs=safeList(store.data.qr_campaigns).filter((q:any)=>String(q.customer_id||'')===String(cid))
 const q=qrs[0]
 const setting=safeList(store.data.customer_reactivation_settings).find((x:any)=>String(x.customer_id||'')===String(cid)&&x.active!==false)
 const staff=safeList(store.data.staff_codes).filter((x:any)=>String(x.customer_id||'')===String(cid)&&x.active!==false)
 const links=safeList(store.data.customer_reactivation_links).filter((x:any)=>String(x.customer_id||'')===String(cid)&&!x?.metadata?.is_test_mail)
 const openLinks=links.filter((l:any)=>['open','created','sent','opened'].includes(String(l.status||'open').toLowerCase()))
 const redeemed=links.filter((l:any)=>['redeemed','reactivated'].includes(String(l.status||'').toLowerCase())||l.redeemed_at)
 const qrLink=q?.slug?qrScanUrl(q.slug):''
 async function copy(value:string){try{await navigator.clipboard?.writeText(value);appToast('Link kopiert')}catch{appToast('Kopieren nicht möglich')}}
 return <div className="grid2"><Card title="Heute wichtig: QR & Loyalty" action={<Badge type={readiness.score>=80?'green':'yellow'}>{readiness.score}% bereit</Badge>}><div className="grid4"><Metric label="QR-Seiten" value={readiness.counts.qr_campaigns}/><Metric label="Teilnehmer" value={readiness.counts.loyalty_customers}/><Metric label="Mailfähig" value={readiness.counts.mail_eligible}/><Metric label="Reaktiviert" value={redeemed.length}/></div><div className="toolbarActions">{qrLink&&<button className="btn" onClick={()=>copy(qrLink)}>QR-Link kopieren</button>}{q?.slug&&<button className="btn secondary" onClick={()=>window.open(`/l/${q.slug}`,'_blank')}>Kundensicht ansehen</button>}<button className="btn secondary" onClick={()=>setView('public_landing')}>QR Zielseite öffnen</button></div><div className="sub">{setting?.reward_name?`Aktuelle Rückhol-Prämie: ${setting.reward_name}`:'Noch keine Rückhol-Prämie gespeichert.'} {staff[0]?.code?`Mitarbeitercode aktiv.`:'Bitte Mitarbeitercode anlegen.'}</div></Card><Card title="Pilot-Checkliste"><PilotChecklist items={readiness.checklist.slice(0,6)}/><button className="btn secondary" onClick={()=>setView('public_landing')}>Einrichtung fortsetzen</button></Card></div>
}

function PilotAdminQuickCard({store,cid,setView}:any){
 const readiness=localPilotReadiness(store.data,cid)
 const customer=cobj(store.data,cid)
 const next=readiness.checklist.find((x:any)=>!x.ok)
 return <Card title="Pilot Readiness" action={<Badge type={readiness.score>=80?'green':'yellow'}>{readiness.score}%</Badge>}><div className="item"><div><b>{customer?.name||customer?.company||'Pilotkunde auswählen'}</b><div className="sub">{next?`Nächster Schritt: ${next.label} – ${next.hint}`:'Pilot-Setup wirkt bereit. Jetzt echten Ablauf testen.'}</div></div><button className="btn" onClick={()=>setView('pilot_readiness')}>Readiness prüfen</button></div></Card>
}

function PilotReadinessCenter({store,cid,setCid,setView}:any){
 const [remote,setRemote]=useState<any>(null)
 const [loading,setLoading]=useState(false)
 const [error,setError]=useState('')
 const local=localPilotReadiness(store.data,cid)
 async function load(){if(!cid)return;setLoading(true);setError('');try{const r=await v33FunctionalClient.pilotReadiness(cid);setRemote(r)}catch(e:any){setError(e.message||'Readiness-Check konnte nicht geladen werden.');setRemote(null)}finally{setLoading(false)}}
 useEffect(()=>{load()},[cid])
 const readiness=remote||local
 const env=safeList(remote?.env_checklist)
 const schema=safeList(remote?.schema)
 const missing=safeList(remote?.missing_schema)
 return <><Head title="Pilot Readiness" sub="V099/V100: System-, Schema- und Kunden-Onboarding-Check für QR, Loyalty und Rückholaktionen" action={<div className="toolbarActions"><button className="btn secondary" onClick={()=>setView('dashboard')}>Dashboard</button><button className="btn" onClick={load} disabled={loading}>{loading?'Prüft...':'Neu prüfen'}</button></div>}/><Card title="Kunde"><Search items={allCustomers(store.data)} value={cid} onChange={setCid} placeholder="Pilotkunden auswählen"/></Card><div className="grid4"><Metric label="Pilot-Score" value={`${readiness.score||0}%`}/><Metric label="QR-Seiten" value={readiness.counts?.qr_campaigns||0}/><Metric label="Mailfähige Kontakte" value={readiness.counts?.mail_eligible||0}/><Metric label="Rückhol-Links" value={readiness.counts?.links||0}/></div>{error&&<Card title="Live-Check nicht erreichbar"><div className="sub">{error}</div><div className="sub">Es wird die lokale Store-Auswertung angezeigt. Für ENV-/Schema-Prüfung Backend-Login und Deployment prüfen.</div></Card>}<div className="grid2"><Card title="Kunden-Onboarding"><PilotChecklist items={readiness.checklist}/></Card><Card title="System-Readiness">{env.length?<PilotChecklist items={env}/>:<div className="sub">Live-ENV-Check wird über Railway geladen. Lokale Ansicht kann ENV-Werte nicht sicher prüfen.</div>}<div className="toolbarActions"><button className="btn secondary" onClick={()=>setView('production_health')}>Production Status öffnen</button><button className="btn secondary" onClick={()=>setView('security_core_live')}>Security öffnen</button></div></Card></div><Card title="Migration / Schema-Check">{schema.length===0?<div className="sub">Noch kein Live-Schema-Check verfügbar.</div>:<div className="grid2">{schema.map((s:any)=><div className="item" key={s.table}><div><b>{s.table}</b><div className="sub">{s.ok?'Alle Pflichtspalten vorhanden':`Fehlt: ${safeList(s.missing).join(', ')||s.error||'unbekannt'}`}</div></div><Badge type={s.ok?'green':'red'}>{s.ok?'OK':'Prüfen'}</Badge></div>)}</div>}{missing.length>0&&<div className="sub">Wenn hier Tabellen/Spalten fehlen: passende Supabase-Migration ausführen und Backend neu testen.</div>}</Card><Card title="Nächste sinnvolle Schritte"><div className="grid4 portalFocusGrid"><div><b>1. Einrichtung abschließen</b><span>Alle gelben Punkte in der Kunden-Onboarding-Liste abarbeiten.</span><button className="btn secondary" onClick={()=>setView('public_landing')}>QR Zielseite</button></div><div><b>2. Testmail senden</b><span>Mailinhalt, Link, Test-Hinweis und Rückholseite prüfen.</span><button className="btn secondary" onClick={()=>setView('public_landing')}>Rückholtool</button></div><div><b>3. Mitarbeitercode testen</b><span>Falscher Code, richtiger Code und Einmal-Einlösung prüfen.</span><button className="btn secondary" onClick={()=>setView('staff_codes')}>Codes</button></div><div><b>4. Pilot starten</b><span>QR ausdrucken, Link verteilen, erste Woche eng begleiten.</span><button className="btn secondary" onClick={()=>setView('reports')}>Reporting</button></div></div></Card></>
}

function V42PublicLandingManager({store,cid}:any){
 const customer=cobj(store.data,cid)
 const [form,setForm]=useState({title:`${customer?.name||'Kunde'} Bonusclub`,slug:slugifyLocal(customer?.name||'kunde'),headline:'Willkommen im Bonusclub',subline:'Sammle Punkte, sichere dir Prämien und werde VIP.',mode:'loyalty'})
 const campaigns=(store.data.qr_campaigns||[]).filter((q:any)=>q.customer_id===cid)
 const [selectedCampaignId,setSelectedCampaignId]=useState('')
 useEffect(()=>{
  if(campaigns.length===0){setSelectedCampaignId('');return}
  if(!selectedCampaignId||!campaigns.some((q:any)=>String(q.id)===String(selectedCampaignId)))setSelectedCampaignId(String(campaigns[0].id))
 },[cid,campaigns.map((q:any)=>String(q.id)).join('|')])
 const selectedCampaign=campaigns.find((q:any)=>String(q.id)===String(selectedCampaignId))||campaigns[0]||null
 async function create(){
  const slug=slugifyLocal(form.slug||form.title)
  const qr=await store.create('qr_campaigns',{customer_id:cid,title:form.title,name:form.title,slug,headline:form.headline,mode:form.mode,purpose:form.mode,metadata:{purpose:form.mode,hero_headline:form.headline,hero_subline:form.subline,cta_label:form.mode==='review'?'Bewertung absenden':'Punkte sammeln',review_cta_label:'Bewertung absenden',points_per_scan:form.mode==='review'?0:1,max_scans_per_member:1,daily_scan_limit_per_member:1,scan_cooldown_minutes:0,daily_point_limit_per_member:1,suspicion_score_threshold:70,final_slug_rules_source:'qr_campaigns',show_staff_pin_on_counter:false},points_per_scan:form.mode==='review'?0:1,max_scans_per_member:1,daily_scan_limit_per_member:1,scan_cooldown_minutes:0,daily_point_limit_per_member:1,suspicion_score_threshold:70,public_url:qrScanUrl(slug),target_url:`/q/${slug}`,status:'Aktiv',active:true,created_at:new Date().toISOString()})
  if(form.mode!=='review'){
   try{const program=await store.create('loyalty_programs',{customer_id:cid,qr_campaign_id:qr?.id,name:`${form.title} Punkteprogramm`,slug:`${slug}-punkte`,status:'active',points_per_scan:1,public_url:`/l/${slug}`,rules:{require_rescan_for_points:true},metadata:{qr_slug:slug,source:'qr_zielseite'}}); if(qr?.id&&program?.id)await store.update('qr_campaigns',qr.id,{loyalty_enabled:true,loyalty_program_id:program.id})}catch(e){console.warn('[MMOS] loyalty program create from QR Zielseite failed',e)}
  }
  await store.create('notifications',{customer_id:cid,title:'Öffentliche QR-Zielseite erstellt',message:`/l/${slug} wurde erstellt. Die finalen Einlöse-Regeln bearbeitest du unten im finalen Slug-Regelblock.`,type:'public_landing',actor_name:'DominiqueMM'})
 }
 return <><Head title="QR Zielseite" sub={`Nur Kampagnen von ${customer?.name||'diesem Kunden'} anzeigen, bearbeiten und previewen`}/><div className="grid2"><Card title="QR-Zielseite erstellen"><div className="sub">Hier legst du die Seite nur an. Die endgültigen Regeln für Scans, Tageslimit, Cooldown und Punkte werden danach ausschließlich im Block <b>Finale Einstellungen für diese öffentliche QR-Zielseite</b> gespeichert.</div><input className="input" value={form.title} onChange={e=>setForm({...form,title:e.target.value})} placeholder="Seitentitel, z. B. Bonusclub des Kunden" title="Interner Name der neuen QR-Zielseite"/><input className="input" value={form.slug} onChange={e=>setForm({...form,slug:slugifyLocal(e.target.value)})} placeholder="Kurzlink, z. B. kundenname-bonusclub" title="Öffentlicher Kurzname in der URL"/><input className="input" value={form.headline} onChange={e=>setForm({...form,headline:e.target.value})} placeholder="Headline, die öffentlich oben angezeigt wird" title="Öffentliche Überschrift der QR-Zielseite"/><textarea className="input textarea" value={form.subline} onChange={e=>setForm({...form,subline:e.target.value})} placeholder="Unterzeile der öffentlichen Landingpage" title="Erklärungstext für Endkunden"/><select className="input" value={form.mode} onChange={e=>setForm({...form,mode:e.target.value})} title="Legt fest, ob die Seite Punkteprogramm, Reviews oder beides kombiniert"><option value="loyalty">Loyalty</option><option value="review">Review</option><option value="both">Bewertung + Punkteprogramm</option><option value="lead">Lead</option></select><button className="btn" onClick={create}>QR-Zielseite erstellen</button></Card><V42PublicLandingPreview campaigns={campaigns} customer={customer}/></div><Card title="Bestehende QR-Zielseiten">{campaigns.length===0&&<div className="sub">Noch keine QR-Zielseite für diesen Kunden.</div>}{campaigns.map((q:any)=><div className="item qrCampaignAssetRow" key={q.id}><div><b>/l/{q.slug}</b><div className="sub">{q.title||q.name}</div></div><QrAssetActions slug={q.slug} title={q.title||q.name||'Scanne & Punkte sammeln'} customerName={customer?.name||customer?.company}/><button className="btn secondary" onClick={()=>window.open(`/l/${q.slug}`,'_blank')}>Zielseite öffnen</button><button className="btn secondary" onClick={()=>store.remove('qr_campaigns',q.id)}>Löschen</button></div>)}</Card><Card title="Finale QR-Zielseiten-Regeln & Texte bearbeiten">{campaigns.length===0&&<div className="sub">Erstelle zuerst eine QR-Zielseite. Danach kannst du die finalen Regeln und öffentlichen Texte ändern.</div>}{campaigns.length>1&&<label className="formField"><span>QR-Kampagne auswählen</span><select className="input" value={selectedCampaignId} onChange={e=>setSelectedCampaignId(e.target.value)}><option value="">Bitte Kampagne wählen</option>{campaigns.map((q:any)=><option key={q.id} value={q.id}>{q.title||q.name||q.slug} · /l/{q.slug}</option>)}</select><div className="fieldHelp">Die folgenden Einstellungen bearbeiten nur die ausgewählte QR-Zielseite.</div></label>}{selectedCampaign&&<LandingTextEditor key={selectedCampaign.id} store={store} q={selectedCampaign}/>}</Card></>
}


function ProductionStatusCard(){
 const [health,setStatus]=useState<any>(null)
 useEffect(()=>{
  let alive=true
  systemStatus()
   .then((r:any)=>{if(alive)setStatus({ok:!!(r?.ok&&r?.ready?.ok!==false),service:r?.service||'MMOS System Center',status:r})})
   .catch((e:any)=>setStatus({ok:false,error:e.message||'Backend nicht erreichbar'}))
  return()=>{alive=false}
 },[])
...
async function v20EnableLoyaltyForQr(customer_id:string, qr_campaign_id:string, name='Punkteprogramm'){
...
function InternalToolsLegacyCenter({setView}:any){
 const groups=[
  {title:'Finanzen',tools:[
   ...
   {label:'Umsatz-Prognose',view:'revenue_forecasting',text:'Prognoses, Risiken und Umsatzentwicklung.'},
   {label:'Smart Pricing',href:'/admin/pricing',text:'Preislogik, Paketwerte und Optimierung.'},
   {label:'Nutzung & Abrechnung',view:'dynamic_billing',text:'Flexible Abrechnung und Paketlogik.'},
   {label:'Umsatzbeteiligung',view:'revenue_share',text:'Umsatzbeteiligungen und interne Verteilung.'}
  ]},
  {title:'Pakete & Freigaben',tools:[
   ...
   {label:'Paket-Empfehlung',view:'package_recommendations',text:'Paketempfehlungen anhand Kundenbedarf.'},
  ...
  {title:'System & Sicherheit',tools:[
   {label:'Production Core Finalization',view:'production_core',text:'Kundenportal-Rechte, Dokumente, Status, Logs, Smoke-Test.'},
   ...
   {label:'Production Status 2.0',view:'production_health',text:'Backend, Supabase, Storage, PDF, Google und letzte Vorgänge.'},
   ...
   {label:'Security & Status Center',view:'security_center',text:'Bestehendes Status- und Sicherheitscenter.'},
 ...
 return <div className="backofficePage">
  <div className="head"><div><p className="eyebrow">Backoffice</p><h1>Backoffice</h1><p className="sub">Alle alten Backoffice-Funktionen: Finanzen, Paketlogik, Freigaben, Sicherheit, Systembetrieb und interne Verwaltung.</p></div><button className="btn secondary" onClick={()=>setView('dashboard')}>Zurück zur Übersicht</button></div>
...
function SalesWorkflowCenter({store,cid,setCid,setView,activeAdmin}:any){
 ...
 async function addEvent(stepKey:string,title:string,description:string){
  if(!cid)return
  await store.create('sales_workflow_events',{customer_id:cid,workflow_id:existing?.id||null,step_key:stepKey,title,description,actor_name:activeAdmin||'Admin',created_at:new Date().toISOString()})
 }
 ...
 async function createPilotWorkflow(){
  ...
  await store.create('qr_campaigns',{customer_id:customer.id,title:'Review QR Kampagne',name:'Review QR Kampagne',slug,public_url:qrScanUrl(slug),target_url:`/q/${slug}`,purpose:'review',status:'Aktiv',active:true,scans:0,conversions:0,created_at:new Date().toISOString()})
  ...
  for(const key of completed_steps){await store.create('sales_workflow_events',{customer_id:customer.id,workflow_id:workflow?.id||null,step_key:key,title:`${key} vorbereitet`,description:'Durch Pilot-Workflow automatisch erstellt.',actor_name:activeAdmin||'Admin',created_at:new Date().toISOString()})}
  setCid(customer.id)
...
function ProductionCoreFinalization({store,cid,setCid,setView,activeAdmin}:any){
 ...
 async function createCommercialChain(){
  ...
  await store.create('invoices',invoice)
  await store.create('sales_workflow_events',{customer_id:cid,workflow_id:workflow?.id||null,step_key:'commercial_chain',title:'Angebot und Rechnung vorbereitet',description:`${offer.title} und ${invoice.invoice_number} wurden aus dem Workflow erzeugt.`,actor_name:activeAdmin,created_at:new Date().toISOString()})
 ...
 return <div className="productionCore"><Head title="Production Core Finalization" sub="Kundenportal-Rechte, Dokumente, Verkaufsworkflow, Status, Logs und Smoke-Test produktionsfähig machen." action={<div className="toolbarActions"><button className="btn secondary" onClick={()=>setView('production_health')}>Status prüfen</button><button className="btn" onClick={runCoreLinking}>Dokumente verknüpfen</button></div>}/>
...
function ProductionStatusDashboardV2({store,cid,setView}:any){
 const [remote,setRemote]=useState<any>(null)
 ...
 return <div><Head title="Production Status 2.0" sub="Technische Einsatzbereitschaft: Backend, Supabase, Storage, PDF, Google, Reports und Rechnungen." action={<button className="btn" onClick={check}>Neu prüfen</button>}/>
...
function SmokeTestCenter({store,cid,setCid,setView,activeAdmin}:any){
 ...
 const tests=[
  ...
  {key:'internal_tools',title:'Interne Werkzeuge integriert',ok:true,action:()=>setView('production_health')},
...
export default function App(){
 ...
 useEffect(()=>{try{if(cid)localStorage.setItem('mmos_customer_id',cid)}catch{}},[cid])
 ...
 const admin=[
   'dashboard','backoffice','sales_workflow','production_core','production_validation','production_health','document_center','action_log','demo_live_guard','smoke_test','admin_training','production_readiness','pilot_readiness','security_core_live','admin_tool_center','admin_profiles','main_landing','demo_environment','crm','finance','tickets','booking','pipeline','automations','workflows','media','qr','public_landing','loyalty','loyalty_rewards','loyalty_rules','staff_codes','loyalty_segments','smart_loyalty','reviews','smart_automation','marketing_automation','ai_assistant','integrations','seo','kpi','customer_health','customer_intelligence','dynamic_billing','revenue_forecasting','revenue_share','package_recommendations','package_matrix','timeline_events','business_audit','mini_audit','lead_scraper','acquisition_campaigns','offer_generator','contract_generator','output_engine','monthly_reports','onboarding','approvals','health_scores','dunning','security_center'
 ]
 const packageToolRoutes:any={
   'QR Kampagnen':'qr',
   'QR Kampagnen verwalten':'qr',
   'QR Zielseite':'public_landing',
   'Zielseite / Slug':'public_landing',
   'Punkteprogramm':'loyalty',
   'Prämien':'loyalty_rewards',
   'Regeln':'loyalty_rules',
   'Mitarbeitercodes':'staff_codes',
   'Kundengruppen':'loyalty_segments',
   'Bonusstufen':'smart_loyalty',
   'Reviews':'reviews',
   ...
   'KI-Empfehlungen':'ai_assistant',
   'Projektstatus':'customer_health',
   'Customer Intelligence':'customer_intelligence',
   'Dynamic Billing':'dynamic_billing',
   'Umsatzprognose':'revenue_forecasting',
   'Umsatzbeteiligung':'revenue_share',
   'Paket-Empfehlungs':'package_recommendations',
   'Paket-Matrix':'package_matrix',
   'Empfehlungen':'customer_intelligence',
   'Nutzung & Abrechnung':'dynamic_billing',
   'Paket-Empfehlung':'package_recommendations',
   'Automatische Regeln':'smart_automation',
   'Automatische Aktionen':'marketing_automation',
   'Pipeline':'pipeline',
   ...
   'Kundenbindung & Wiederkehrer':'retention_intelligence',
   'Kundenbindung':'retention_intelligence',
   'Consent Center & Double-Opt-in':'consent_center',
   'Consent Center':'consent_center',
   'Einwilligungen':'consent_center',
   'Segment-Kampagnen':'segment_campaigns',
   'Segment Kampagnen':'segment_campaigns',
   'Kundenaktionen':'segment_campaigns',
   'Churn Prevention':'churn_prevention',
   'Rückhol-Chancen':'reactivation',
   'Rückholaktionen':'reactivation',
   'SumUp Umsatzdaten':'sumup_revenue_connection',
   'SumUp Integration':'sumup_revenue_connection'
 }
 const customer=['dashboard','seo','qr','reports','documents_billing']
 const labels:any={
   dashboard:'Dashboard',backoffice:'Backoffice',sales_workflow:'Verkaufsworkflow',production_validation:'Production Validation',smoke_test:'Smoke-Test',demo_live_guard:'Demo-/Live-Trennung',action_log:'Admin-Aktionslog',document_center:'Dokumenten-Zentrale',production_health:'Production Status',production_core:'Production Core',admin_tool_center:'Tool-Zentrale',admin_training:'Wissenstest',production_readiness:'Production Readiness',pilot_readiness:'Pilot Readiness',security_core_live:'Security Core',admin_profiles:'Admin Profile',main_landing:'Haupt-Landingpage',crm:'CRM',finance:'Rechnungen',tickets:'Tickets',booking:'Booking',pipeline:'Pipeline',automations:'Automationen',workflows:'Workflows',activity:'Aktivitäten',media:'Dateien',qr:'QR Kampagnen verwalten',demo_customers:'Test Kunden',demo_environment:'Interne Testumgebung',integrations:'Integrationen',packages:'Pakete & Billing',public_landing:'QR Zielseite',loyalty:'Punkteprogramm',loyalty_rewards:'Prämien',loyalty_rules:'Regeln',staff_codes:'Mitarbeitercodes',loyalty_segments:'Kundengruppen',smart_loyalty:'Bonusstufen',reviews:'Reviews',review_intelligence:'Review Intelligence',review_templates:'Antwortvorlagen',smart_automation:'Automatische Regeln',marketing_automation:'Automatische Aktionen',ai_assistant:'KI-Empfehlungen',customer_health:'Projektstatus',customer_intelligence:'Empfehlungen',dynamic_billing:'Nutzung & Abrechnung',revenue_forecasting:'Umsatzprognose',revenue_share:'Umsatzbeteiligung',package_recommendations:'Paket-Empfehlung',package_matrix:'Paket-Matrix',retention_intelligence:'Kundenbindung',consent_center:'Einwilligungen',segment_campaigns:'Kundenaktionen',churn_prevention:'Rückhol-Chancen',reactivation:'Rückholaktion',sumup_revenue_connection:'SumUp Integration',timeline_events:'Timeline Events',seo:'Google & Sichtbarkeit',review:'Review Funnel',customer_automations:'Automationen',customer_workflows:'Workflow Center',roles:'Rechte',kpi:'KPI Analytics',heatmap:'SEO Heatmap',success:'Client Success Score',advanced_reports:'Advanced Reports',knowledge:'Wissenscenter',competitors:'Wettbewerber Vergleich',onboarding:'Onboarding',reports:'Reports',approvals:'Freigaben',output_engine:'Output Engine',monthly_reports:'Monatsreport Generator',business_audit:'Google Business Audit',mini_audit:'Mini-Audit Generator',lead_scraper:'Lead Scraper',acquisition_campaigns:'Akquise-Kampagnen',offer_generator:'Angebotsgenerator',contract_generator:'Vertragsgenerator',health_scores:'Kunden-Erfolgsampel',dunning:'Mahnwesen',documents_billing:'Dokumente & Rechnungen',health_center:'Security & Status Center',security_center:'Security & Status Center'
 }
 const visibleNavKeys=role==='admin'?admin:customer
 const adminNavGroups=[
   {label:'Cockpit',hint:'Zentrale Übersicht',tools:['dashboard']},
   {label:'Kunden',hint:'CRM, Kundenstatus, Dateien, Termine und Support',tools:['crm','customer_health','customer_intelligence','tickets','booking','media','onboarding','knowledge']},
   {label:'Akquise',hint:'Leads, Kampagnen, Verkaufsworkflow und Pipeline',tools:['sales_workflow','lead_scraper','acquisition_campaigns','pipeline']},
   {label:'Google & Audits',hint:'Google Business, SEO, KPIs, Heatmap, Wettbewerber und Mini-Audits',tools:['integrations','seo','kpi','competitors','business_audit','mini_audit','reviews','review_intelligence','review_templates']},
   {label:'QR Kampagnen',hint:'QR, Zielseite, Bewertungen, Punkte, Prämien, Regeln und Codes',tools:['qr']},
   {label:'Reports & Dokumente',hint:'Reports, Freigaben, Dokumente und Output',tools:['monthly_reports','reports','approvals','output_engine','document_center']},
   {label:'Rechnungen',hint:'Rechnungen, Mahnwesen, Nutzung und Umsatzübersicht',tools:['finance','dunning','dynamic_billing','revenue_forecasting','revenue_share']},
   {label:'Pakete',hint:'Paketmatrix, Empfehlungen und Paketfreigaben',tools:['package_matrix','package_recommendations','packages']},
   {label:'Backoffice',hint:'Interne Funktionen, Production, Sicherheit, Logs, Admins und Automationen',tools:['backoffice','production_core','production_validation','production_health','action_log','demo_live_guard','smoke_test','production_readiness','pilot_readiness','security_core_live','security_center','admin_tool_center','admin_profiles','main_landing','demo_environment','admin_training','automations','workflows','smart_automation','marketing_automation','ai_assistant','customer_workflows','timeline_events','retention_intelligence','consent_center','segment_campaigns','churn_prevention']}
 ]
 const customerNavGroups=[
   {label:'Start',hint:'Status, Aufgaben und Empfehlungen',tools:['dashboard']},
   {label:'Google & Sichtbarkeit',hint:'Google Business, SEO KPIs und Heatmap',tools:['seo']},
   {label:'QR Kampagnen',hint:'QR-Kampagnen, Zielseite und KPIs',tools:['qr']},
   {label:'Reports',hint:'Monatsberichte und Ergebnisse',tools:['reports']},
   {label:'Dokumente & Rechnungen',hint:'Rechnungen, PDFs und hochgeladene Dateien',tools:['documents_billing']}
 ]
 const navGroupsSource=role==='admin'?adminNavGroups:customerNavGroups
  const usedNavTools=new Set<string>()
  const navGroups=navGroupsSource
    .map((g:any)=>({...g,tools:g.tools.filter((k:string)=>{
      if(!visibleNavKeys.includes(k))return false
      if(k==='demo_environment'&&!isDemoFeatureEnabled())return false
      if(usedNavTools.has(k))return false
      usedNavTools.add(k)
      return true
    })}))
    .filter((g:any)=>g.tools.length>0)
 const navGroupByTool=Object.fromEntries(navGroups.flatMap((g:any)=>g.tools.map((k:string)=>[k,g.label])))
 useEffect(()=>{
  const next=navGroupByTool[view]||navGroups[0]?.label||''
  if(!next)return
  setExpandedNavGroup((prev:string)=>prev&&navGroups.some((g:any)=>g.label===prev)?prev:next)
 },[view,role,cid,navGroups.map((g:any)=>`${g.label}:${g.tools.join(',')}`).join('|')])
 if(role==='guest'){
  return <CustomerLandingV26 />
 }
 const nav=role==='admin'?admin:customer
 const mobileBottomKeys=(role==='admin'?['dashboard','lead_scraper','acquisition_campaigns','crm','security_center']:['dashboard','seo','qr','reports','documents_billing']).filter((k:string)=>visibleNavKeys.includes(k))
...
{view==='production_core'&&role==='admin'&&<ProductionCoreFinalization store={store} cid={cid} setCid={setCid} setView={setView} activeAdmin={activeAdmin}/>} 
 ...
 {view==='production_health'&&role==='admin'&&<ProductionStatusDashboardV2 store={store} cid={cid} setView={setView}/>} 
 ...
 {view==='pilot_readiness'&&role==='admin'&&<PilotReadinessCenter store={store} cid={cid} setCid={setCid} setView={setView}/>}
 {view==='security_core_live'&&role==='admin'&&<SecurityCorePanel/>}
  {view==='backoffice'&&role==='admin'&&<InternalToolsLegacyCenter setView={setView}/>}
 ...
 {view==='crm'&&role==='admin'&&<CRM store={store} cid={cid} setCid={setCid} setView={setView} activeAdmin={activeAdmin} adminAvatars={adminAvatars}/>}
 {view==='finance'&&<Finance store={store} cid={cid} role={role} activeAdmin={activeAdmin}/>}
{view==='documents_billing'&&<CustomerDocumentsBilling store={store} cid={cid}/>}
 ...
 {['qr','public_landing','loyalty','loyalty_rewards','loyalty_rules','staff_codes','reactivation','loyalty_segments','smart_loyalty'].includes(view)&&<QRCodes store={store} cid={cid} setCid={role==='admin'?setCid:undefined} role={role} activeView={view}/>}
...
function MobileContextStrip({store,cid,role,view,labels,setView,openMenu}:any){
 ...
 const quicks=role==='admin'
  ...
  :[{key:'dashboard',label:'Start'},{key:'seo',label:'Google'},{key:'qr',label:'QR'},{key:'reports',label:'Reports'},{key:'documents_billing',label:'Dokumente'}]
...
function MobileAppBottomNav({role,view,keys,labels,setView,openMenu}:any){
 const icon:any={dashboard:'⌂',seo:'◌',qr:'◇',reports:'▤',documents_billing:'€',reviews:'★',finance:'€',lead_scraper:'◎',acquisition_campaigns:'↗',crm:'◍',health_center:'✓',security_center:'🛡'}
 const short:any={dashboard:'Start',seo:'Google',qr:'QR',reports:'Reports',documents_billing:'Dokumente',lead_scraper:'Leads',acquisition_campaigns:'Akquise',health_center:'Status',security_center:'Security'}
...
function customerStatusSnapshot(d:any,cid:string){
...
function CustomerSuccessTrafficLight({store,setCid,setView}:any){
 ...
 const rows=allCustomers(store.data).filter((c:any)=>!c.is_demo).map((c:any)=>{
  ...
  const calc=customerStatusSnapshot(store.data,c.id)
 ...
 return <><Head title="Kunden-Erfolgsampel" sub="Frühwarnsystem für Kündigungsrisiko, offene Themen und Upgrade-Chancen"/>
...
function SecurityCenterV42({store,cid,setCid}:any){
 ...
 async function load(){try{setRemote(await systemStatus());setMsg('Security & Status geprüft.')}catch(e:any){setRemote({ok:true,mode:'local_fallback',health:{ok:false,reason:e.message||'Backend nur mit Live-Admin-Session erreichbar'},customer_access:{protected_tables:'lokal',tables:[]},controls:{demo_live_separation:true,qr_daily_point_limit:true,loyalty_suspicion_score:true,dsar_workflow:true}});setMsg('Backend-Diagnose nicht authentifiziert – lokale Demo-/Fallback-Prüfung angezeigt.')}}
 useEffect(()=>{load()},[])
 async function saveSettings(){
 ...
 <StatusCenterV42 store={store}/></>
}

function StatusCenterV42({store}:any){
 ...
 async function run(){
  ...
  const localBt={ok:true,mode:'local_fallback',google_places:false,note:'Business-Tools-Status wird lokal angezeigt, bis eine Live-Admin-Session verfügbar ist.'}
 ...
 return <><Head title="Status Center" sub="Systemstatus, Migrationen, Live/Lokal-Status, API-Keys und Datenintegrität" action={<div className="toolbarActions"><LocalLiveBadge/><button className="btn" onClick={run}>Neu prüfen</button></div>}/>
...
function V42QrCodePanel({cid}:any){
 ...
 async function create(){
  ...
  try{
   const r=await v33FunctionalClient.createQrCampaign(cid,{title:'QR Punkteprogramm Kampagne',purpose:'loyalty',points_per_scan:10})
   setData(r)
 ...
 const url=slug?`${appBase.replace(/\/+$/,'')}/q/${slug}`:''
 return <Card title="QR Kampagne erstellen" action={<button className="btn secondary" onClick={create}>QR + Punkteprogramm erstellen</button>}>{url?<div className="qrExport"><V424QrImage value={url}/><div><b>{url}</b><p className="sub">QR wird serverseitig im MMOS-Backend erzeugt — keine Übermittlung an Drittanbieter.</p><div className="toolbarActions"><button className="btn secondary" onClick={()=>navigator.clipboard?.writeText(url)}>QR-Link kopieren</button><button className="btn secondary" onClick={()=>window.open(url,'_blank')}>Slug öffnen</button><a className="btn secondary" href={qrServerUrl(url)} target="_blank" rel="noopener">QR als Bild öffnen</a></div></div></div>:<div className="sub">Noch kein QR erstellt. Klicke auf „QR + Punkteprogramm erstellen“.</div>}<input className="input" value={manualSlug} onChange={e=>setManualSlug(e.target.value)} placeholder="Optional: vorhandenen Slug manuell eingeben, z. B. kunde-bonusclub"/>{msg&&<div className="sub">{msg}</div>}</Card>
}
...
function V42PackageRecommendations({cid}:any){
 const [data,setData]=useState<any>(null)
 useEffect(()=>{v33FunctionalClient.packageRecommendations(cid).then((r:any)=>setData(r)).catch(()=>setData({recommendation:{customer_name:'Ausgewählter Kunde',addon:'Growth/Premium Add-on',price:499,confidence:84,reason:['Aktive Nutzungssignale','Paket-Fit vorhanden','Upgrade im nächsten Kundengespräch möglich']}}))},[cid])
 const r=data?.recommendation
 return <><Head title="Paket-Empfehlung" sub="Kunde · Add-on · Begründung"/>{r&&<Card title={`Empfehlung für ${r.customer_name}`}><div className="v40Deal"><b>{r.addon}</b><strong>{eur(r.price)}</strong><span>Confidence: {r.confidence}%</span>{r.reason.map((x:string)=><p key={x}>✓ {x}</p>)}</div></Card>}</>
}
...
function V42AnalyticsBilling({store,cid}:any){
 ...
 return <><Head title="Auswertung & Abrechnung" sub="Live Kennzahlen · Nutzung · Abrechnung" action={<button className="btn secondary" onClick={load}>Neu berechnen</button>}/><div className="grid4"><Metric label={<span>QR Scans <InfoI text="Anzahl der gescannten QR-Codes über alle Kampagnen dieses Kunden."/></span>} value={a.qr_scans??'-'}/><Metric label={<span>Reviews <InfoI text="Erfasste Bewertungen und Feedbacks aus QR-, Review- und Kundenportal-Flows."/></span>} value={a.reviews??'-'}/><Metric label={<span>Projektstatus <InfoI text="Statuswert aus Nutzung, Bewertungen, Tickets, Rechnungen und Aktivität."/></span>} value={a.health??'-'}/><Metric label={<span>Prognose <InfoI text="Erwarteter Umsatz aus Paket, Nutzung, Pipeline und Erweiterungen."/></span>} value={eur(a.forecast??0)}/></div><div className="grid2"><Card title="Abrechnung"><div className="item"><b>Nutzung gesamt <InfoI text="Summe aus Paket- und nutzungsabhängigen Abrechnungspositionen."/></b><span>{eur(data?.billing?.total??0)}</span></div><div className="item"><b>Umsatzbeteiligung <InfoI text="Berechneter Anteil aus Umsatzbeteiligungsregeln."/></b><span>{eur(a.revenue_share??0)}</span></div><div className="item"><b>Pipeline Value <InfoI text="Gewichteter Wert offener Verkaufschancen."/></b><span>{eur(a.pipeline_value??0)}</span></div>{msg&&<div className="sub">{msg}</div>}</Card><Card title="Auswertungs-Signale"><div className="v40Bars">{[['QR',a.qr_scans||0],['Reviews',a.reviews||0],['Status',a.health||0],['Upgrade',a.upsell||0]].map(([k,v]:any)=><div key={k}><b>{k}</b><div><span style={{width:`${Math.min(100,Number(v))}%`}}></span></div><em>{v}</em></div>)}</div></Card></div></>
}
...
function V41PrognoseDetail({cid}:any){
 const [data,setData]=useState<any>(null),[msg,setMsg]=useState('')
 const emptyPrognose={forecast:{series:[],assumptions:[]}}
 async function load(){try{const r=await v33FunctionalClient.deepModules(cid);const detail=r?.detail||emptyPrognose;const series=safeList(detail?.forecast?.series).filter((m:any)=>Number(m.expected||m.optimistic||m.conservative||0)>0);setData({forecast:{...(detail.forecast||{}),series,assumptions:series.length?safeList(detail?.forecast?.assumptions):[]}});setMsg(series.length?'Prognose geladen':'Keine Live-Daten für Prognose vorhanden')}catch(e:any){setData(emptyPrognose);setMsg('Keine Live-Daten für Prognose vorhanden')}}
 useEffect(()=>{load()},[cid])
 const f=data?.forecast
 return <V41DeepModuleShell cid={cid} title="Umsatzprognose Detail" sub="Prognose · Monatsvergleich · Annahmen · Confidence"><div className="grid2"><Card title="6-Monats Prognose" action={<button className="btn secondary" onClick={load}>Neu berechnen</button>}>{(f?.series||[]).length===0?<EmptyState icon="€" title="Noch kein Live-Prognose vorhanden">Lege echte Live-Kunden, Angebote oder Rechnungen an. Ohne Live-Daten bleibt der Prognose bewusst bei 0 €.</EmptyState>:<><div className="v41PrognoseChart">{(f?.series||[]).map((m:any)=><div key={m.month}><b>{m.month}</b><div className="v41PrognoseBars"><span style={{height:`${Math.max(10,Math.min(100,m.conservative/20))}%`}}></span><span style={{height:`${Math.max(10,Math.min(100,m.expected/20))}%`}}></span><span style={{height:`${Math.max(10,Math.min(100,m.optimistic/20))}%`}}></span></div><em>{eur(m.expected)}</em></div>)}</div><div className="sub">Dunkel = konservativ · Gold = erwartet · hell = optimistisch</div></>}</Card><Card title="Annahmen & Confidence">{(f?.assumptions||[]).map((a:string)=><div className="item" key={a}><b>✓</b><span>{a}</span></div>)}{(f?.series||[]).map((m:any)=><div className="item" key={m.month}><b>{m.month}</b><span>Confidence {m.confidence}% · Erwartet {eur(m.expected)}</span></div>)}{msg&&<div className="sub">{msg}</div>}</Card></div></V41DeepModuleShell>
}
...
function V41RevenueShareDetail({cid}:any){
 ...
 return <V41DeepModuleShell cid={cid} title="Umsatzbeteiligung Detail" sub="Abrechnung · Komponenten · Transparenz"><Card title="Umsatzbeteiligung Aufschlüsselung"><div className="v41ShareDonut"><div><b>{eur(rs?.total||0)}</b><span>gesamt</span></div></div>{!(rs?.items||[]).length&&<EmptyState icon="€" title="Noch keine Live-Daten vorhanden">Umsatzbeteiligung wird erst angezeigt, wenn echte Umsätze oder Usage-Daten synchronisiert wurden.</EmptyState>}{(rs?.items||[]).map((x:any)=><div className="item" key={x.label}><b>{x.label}</b><span>{eur(x.base)} × {x.percent}%</span><Badge type="green">{eur(x.amount)}</Badge></div>)}</Card></V41DeepModuleShell>
}
...
function V41AiAssistantDetail({cid}:any){
 ...
 const ai=data?.ai
 return <V41DeepModuleShell cid={cid} title="KI-Empfehlungen Detail" sub="Chat · Insight-Verlauf · Warum-Erklärung"><div className="grid2"><Card title="KI-Empfehlungen Verlauf">{!(ai?.insights||[]).length&&<EmptyState icon="AI" title="Noch keine Assistant-Insights vorhanden">Insights erscheinen, sobald der Backend-Assistant echte Kundensignale verarbeitet.</EmptyState>}{(ai?.insights||[]).map((x:any)=><div className="v41AiBubble" key={x.title}><div className="v40Avatar">AI</div><div><b>{x.title}</b><p>{x.message}</p>{(x.reasons||[]).map((r:string)=><Badge key={r}>{r}</Badge>)}<em>Aktion: {x.action}</em></div></div>)}</Card><Card title="KI testen"><textarea className="input" value={input} onChange={e=>setInput(e.target.value)}/><div className="toolbarActions"><button className="btn" onClick={ask}>KI fragen</button><button className="btn secondary" onClick={()=>setInput('Erzeuge eine Follow-up Aufgabe aus den aktuellen Reviews')}>Review Follow-up</button><button className="btn secondary" onClick={()=>setInput('Welche Paketempfehlung passt für diesen Kunden?')}>Paketempfehlung</button></div>{msg&&<div className="v41AiAnswer">{msg}</div>}{history.map((h:any,i:number)=><div className="item" key={i}><b>{h.q}</b><span>{h.a}</span></div>)}</Card></div></V41DeepModuleShell>
}
...
function V40AutomationStudio({cid}:any){
 ...
 const triggers=['QR Scan','Neuer Lead','Reward eingelöst','VIP Level-Up','Negative Review','Inaktiv 30 Tage','Upgrade > 80']
...
function V40AiInsightFeed({cid}:any){
 ...
 useEffect(()=>{load()},[cid])
 return <><Head title="KI-Empfehlungen" sub="Insight Feed · Warum-Erklärungen · Empfehlungen"/><Card title="KI-Empfehlungen" action={<button className="btn secondary" onClick={load}>Neu laden</button>}>{(data?.ai_explanations||[]).map((x:any)=><div className="v40Chat" key={x.title}><div className="v40Avatar">AI</div><div><b>{x.title}</b><p>{(x.reason||[]).join(' · ')}</p><Badge type={x.severity==='warn'?'red':'green'}>Warum sehe ich das?</Badge></div></div>)}{msg&&<div className="sub">{msg}</div>}</Card></>
}

function V40StatusRadar({cid,store,mode='health'}:any){
 const [data,setData]=useState<any>(null)
...
function V40RevenueChart({cid,mode='forecast'}:any){
 ...
 const bars=[['Usage',data?.billing?.total||0],['Prognose',s.forecast||0],['Share',s.revenue_share||0],['Upgrade',s.upsell||0]]
 return <><Head title={mode==='billing'?'Abrechnungs-Vorschau':mode==='share'?'Umsatzbeteiligung':'Umsatzprognose'} sub="Billing & Revenue · Chart · Vorschau"/><Card title="Umsatzübersicht" action={<button className="btn secondary" onClick={load}>Neu berechnen</button>}><div className="v40Bars">{bars.map(([k,v]:any)=><div key={k}><b>{k}</b><div><span style={{width:`${Math.min(100,Number(v)/10)}%`}}></span></div><em>{v}</em></div>)}</div>{msg&&<div className="sub">{msg}</div>}</Card></>
}
...
function V40PackageDeals({cid}:any){
 ...
 return <><Head title="Paket-Empfehlung" sub="Deals · Upgrade · Empfehlungen"/><div className="grid2"><Card title="Empfohlenes Add-on"><div className="v40Deal"><b>{upsell>75?'Premium Growth Add-on':'Punkteprogramm Booster'}</b><span>Upgrade Score: {upsell}</span><strong>{upsell>75?'499 €':'199 €'}</strong><button className="btn">Als Chance markieren</button></div></Card><Card title="Warum?"><div className="sub">Empfehlung basiert auf QR-Aktivität, Leads, Usage und Projektstatus.</div></Card></div></>
}
...
function V38BillingRevenueHub({cid}:any){
 ...
 return <Card title="Billing & Revenue Hub" action={<button className="btn secondary" onClick={load}>Neu berechnen</button>}><div className="sub">Paket, Usage, Prognose, Umsatzbeteiligung und Paket-Empfehlung werden zusammengeführt.</div>{data&&<div className="grid4"><Metric label="Usage" value={data.billing?.total??'-'}/><Metric label="Prognose" value={data.snapshot?.forecast??'-'}/><Metric label="Umsatzbeteiligung" value={data.snapshot?.revenue_share??'-'}/><Metric label="Upgrade" value={data.snapshot?.upsell??'-'}/></div>}{(data?.records||[]).slice(0,6).map((r:any)=><div className="item" key={r.id}><b>{r.resource}</b><span>{r.title}</span><Badge>{r.status}</Badge></div>)}{msg&&<div className="sub">{msg}</div>}</Card>
}
...
function V38TriggerLibrary({cid}:any){
 const triggers=['QR Scan erfolgt','Neuer Lead entsteht','Reward eingelöst','Kunde wird VIP','Negative Review entsteht','Kunde 30 Tage inaktiv','Tageslimit erreicht','Referral Lead entsteht','Upgrade Score > 80']
 const [msg,setMsg]=useState('')
...
function V37LoyaltyBuilder({cid}:any){
 ...
 async function save(){
  setMsg('Speichere Punkteprogramm Branding & Regeln...')
  try{const r=await v33FunctionalClient.saveLoyaltySettings(cid,settings);setSettings(r.settings);setMsg('Punkteprogramm Branding & Regeln gespeichert')}catch(e:any){setMsg(e.message)}
 }
 async function saveReward(){
...
function V37QrDesignPreview({settings,url}:any){
 const qr=qrServerUrl(url||'/q/slug',{size:512,fg:String(settings.qr_foreground||'#111827'),bg:String(settings.qr_background||'#ffffff')})
...
function qrPrintableHtml({title, subtitle, url, qr, brand}:{title:string;subtitle?:string;url:string;qr:string;brand?:string}){
 const esc=(v:any)=>String(v||'').replace(/[&<>\"]/g,(ch:any)=>({'&':'&amp;','<':'&lt;','>':'&gt;','\"':'&quot;'}[ch]||ch))
 return `<!doctype html><html><head><meta charset="utf-8"/><title>${esc(title)}</title><style>body{font-family:Inter,Arial,sans-serif;margin:0;background:#f7f4ec;color:#111827}.sheet{width:794px;min-height:1123px;margin:0 auto;background:white;padding:64px;box-sizing:border-box}.badge{display:inline-block;border:1px solid #d4af37;border-radius:999px;padding:8px 14px;color:#7c5d12;background:#fff8df;font-weight:800;letter-spacing:.04em;text-transform:uppercase;font-size:12px}h1{font-size:44px;line-height:1.05;margin:32px 0 12px}p{font-size:18px;line-height:1.55;color:#4b5563}.qr{display:flex;align-items:center;justify-content:center;margin:44px auto 28px;width:430px;height:430px;border:1px solid #e5e7eb;border-radius:32px;box-shadow:0 24px 80px rgba(17,24,39,.12)}.qr img{width:360px;height:360px}.url{font-size:16px;color:#111827;background:#f3f4f6;border-radius:16px;padding:16px;word-break:break-all}.steps{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-top:28px}.steps div{background:#f9fafb;border:1px solid #e5e7eb;border-radius:18px;padding:18px;font-size:15px}.footer{margin-top:52px;color:#9ca3af;font-size:13px}@media print{body{background:white}.sheet{box-shadow:none;margin:0;width:100%;min-height:auto}.noPrint{display:none}}</style></head><body><main class="sheet"><span class="badge">${esc(brand||'MecklenburgMarketing')}</span><h1>${esc(title)}</h1><p>${esc(subtitle||'Scanne den QR-Code und sichere dir deine Vorteile.')}</p><div class="qr"><img src="${esc(qr)}" alt="QR Code"/></div><div class="url">${esc(url)}</div><section class="steps"><div><b>1. Scannen</b><br/>QR-Code mit dem Smartphone öffnen.</div><div><b>2. Teilnehmen</b><br/>E-Mail eintragen und Punkte sammeln.</div><div><b>3. Wiederkommen</b><br/>Rewards sichern und Prämien einlösen.</div></section><p class="footer">Erstellt mit MecklenburgMarketing OS. Nur für den jeweiligen Betrieb bestimmt.</p><p class="noPrint"><button onclick="window.print()" style="padding:12px 18px;border-radius:999px;border:0;background:#111827;color:white;font-weight:800">Drucken / PDF speichern</button></p></main></body></html>`
}

function openQrPrintSheet({title,subtitle,url,qr,brand}:{title:string;subtitle?:string;url:string;qr:string;brand?:string}){
 if(typeof window==='undefined')return
 const w=window.open('', '_blank')
 if(!w)return
 w.document.open()
 w.document.write(qrPrintableHtml({title,subtitle,url,qr,brand}))
 w.document.close()
}

async function downloadQrPng({url,qr,slug}:{url:string;qr:string;slug?:string}){
 try{
  const response=await fetch(qr,{cache:'no-store'})
  if(!response.ok)throw new Error('QR konnte nicht geladen werden')
  ...
  const a=document.createElement('a');a.href=qr;a.download=`qr-${slug||'scan'}.png`;a.target='_blank';a.click()
 }
}

function QrAssetActions({slug,title,customerName,compact=false}:{slug?:string;title?:string;customerName?:string;compact?:boolean}){
 const publicBase=process.env.NEXT_PUBLIC_APP_URL || (typeof window!=='undefined'?window.location.origin:'')
 const scanUrl=slug?`${publicBase}/q/${slug}`:''
 const displayUrl=slug?`/qr-display/${slug}`:''
 const qr=scanUrl?qrServerUrl(scanUrl,{size:900}):''
 async function copy(){try{await navigator.clipboard.writeText(scanUrl)}catch{}}
 if(!slug||!scanUrl)return null
 const printableTitle=title||'Scanne & Punkte sammeln'
 const printableSub=customerName?`QR-Code für ${customerName}. Dieser Code führt direkt zur sicheren Scan-Seite.`:'Dieser QR-Code führt direkt zur sicheren Scan-Seite.'
 return <div className={compact?'toolbarActions qrAssetActions compact':'toolbarActions qrAssetActions'}><button className="btn secondary" onClick={copy}>QR-Link kopieren</button><button className="btn secondary" onClick={()=>window.open(displayUrl,'_blank')}>QR öffnen</button><button className="btn secondary" onClick={()=>window.open(`/counter/${slug}`,'_blank')}>Tresenmodus</button><button className="btn secondary" onClick={()=>downloadQrPng({url:scanUrl,qr,slug})}>PNG herunterladen</button><button className="btn secondary" onClick={()=>openQrPrintSheet({title:printableTitle,subtitle:printableSub,url:scanUrl,qr,brand:customerName})}>A4-Plakat</button><button className="btn secondary" onClick={()=>openQrPrintSheet({title:'Scannen & Punkte sammeln',subtitle:'Ideal als Tischaufsteller: QR öffnen, anmelden und Vorteile sichern.',url:scanUrl,qr,brand:customerName})}>Tischaufsteller</button><button className="btn secondary" onClick={()=>openQrPrintSheet({title:'Bonus sichern',subtitle:'Kassen-/To-Go-Sticker: schnell scannen und Punkte sammeln.',url:scanUrl,qr,brand:customerName})}>Sticker/Flyer</button></div>
}

function V36QrExport({slug,path,title,customerName}:{slug?:string;path?:string;title?:string;customerName?:string}){
 const publicBase=process.env.NEXT_PUBLIC_APP_URL || (typeof window!=='undefined'?window.location.origin:'')
 const url=slug?`${publicBase}/q/${slug}`:(path?`${publicBase}${path}`:'')
 const qr=qrServerUrl(url,{size:512})
 async function copy(){try{await navigator.clipboard.writeText(url)}catch{}}
 if(!url)return null
 return <div className="qrExport"><img src={qr} alt="QR Code"/><div><b>Scan-Link</b><div className="sub">{url}</div><div className="toolbarActions"><button className="btn secondary" onClick={copy}>Link kopieren</button>{slug&&<QrAssetActions slug={slug} title={title} customerName={customerName} compact/>}</div></div></div>
}
...
function V35BusinessEnginePanel({cid}:any){
 ...
 return <Card title="Business Engine" action={<button className="btn secondary" onClick={()=>run(()=>v33FunctionalClient.recalculateCustomer(cid),'Recalculate')}>Alles neu berechnen</button>}><div className="sub">Produktionsnahe Live-Engine: Status, Intelligence, Billing, Prognose, Umsatzbeteiligung, Recommendations und AI-Hinweise werden aus echten Kundensignalen berechnet.</div><div className="toolbarActions"><button className="btn secondary" onClick={()=>run(()=>v33FunctionalClient.runAutomation(cid,{}),'Automation Engine')}>Automation Engine</button><button className="btn secondary" onClick={()=>run(()=>v33FunctionalClient.runMarketing(cid,{name:'Marketing Booster'}),'Marketing Engine')}>Marketing Engine</button><button className="btn secondary" onClick={()=>run(()=>v33FunctionalClient.calculateBilling(cid),'Billing Engine')}>Billing Engine</button></div>{msg&&<div className="sub">{msg}</div>}{snapshot&&<div className="grid4"><Metric label="Status" value={snapshot.health??snapshot.snapshot?.health??'-'}/><Metric label="Risiko" value={snapshot.risk??snapshot.snapshot?.risk??'-'}/><Metric label="Upgrade" value={snapshot.upsell??snapshot.snapshot?.upsell??'-'}/><Metric label="Prognose" value={snapshot.forecast??snapshot.snapshot?.forecast??'-'}/></div>}</Card>
}
...
function V34CustomerProvisioning({cid}:any){
 ...
 return <Card title="Kunden-Provisioning" action={<button className="btn secondary" onClick={bootstrap}>Daten laden</button>}><div className="sub">Für jeden neu angelegten Kunden kannst du automatisch QR-Kampagne, Punkteprogramm, Landingpage und Standard-Code erzeugen.</div><button className="btn" onClick={provision}>Kunden für QR & Punkteprogramm vorbereiten</button>{msg&&<div className="sub">{msg}</div>}{data?.public_url_path&&<div className="item"><b>Öffentliche Endkundenseite</b><span>{data.public_url_path}</span><Badge type="green">scanbereit</Badge></div>}{data?.qr_campaign?.slug&&<div className="item"><b>QR Kurzlink</b><span>{data.qr_campaign.slug}</span></div>}{data?.qr_campaign?.slug&&<V36QrExport slug={data.qr_campaign.slug}/>}</Card>
}
...
function V33LeadQuickCheck({cid}:any){
 ...
 return <Card title="QR & Punkteprogramm Leads" action={<button className="btn secondary" onClick={load}>Leads laden</button>}><div className="sub">Lead-Test: Öffne eine echte QR-Zielseite, sammle Punkte und lade danach hier die Leads.</div>{error&&<Badge type="red">{error}</Badge>}{data?.leads?.slice(0,5).map((l:any)=><div className="item" key={l.id}><b>{l.name||l.email||'QR Lead'}</b><span>{l.email||l.phone||'ohne Kontakt'} · {l.points_added||0} Punkte</span><Badge type="green">Lead</Badge></div>)}</Card>
}
...
function AdminMobileCommandCenter({store,setView,pending,todayFollowUps,redCustomers,openTickets,revenue}:any){
 ...
 const tasks=[
  ...
  {label:'Risiko-Kunden',value:redCustomers.length,desc:'Status prüfen',view:'health_scores',tone:redCustomers.length?'red':'green'},
...
function CRM({store,cid,setCid,setView,activeAdmin,adminAvatars}:any){return <><Head title="CRM Kundenakte" sub={cname(store.data,cid)} action={<LiveModeBadge/>}/><CustomerAccessPanel store={store} cid={cid} activeAdmin={activeAdmin}/><CustomerInfo store={store} cid={cid}/><CustomerDeleteDangerZone store={store} cid={cid} setCid={setCid} setView={setView}/><PackageControl store={store} cid={cid} activeAdmin={activeAdmin}/><QuickCRM store={store} cid={cid}/><div className="grid2"><CRMInvoices store={store} cid={cid}/><CRMNotes store={store} cid={cid} activeAdmin={activeAdmin}/></div><div className="grid2"><Card title="Verträge"><FileList store={store} cid={cid} type="contracts"/></Card><Card title="Media"><FileList store={store} cid={cid}/></Card></div></>}
...
function CustomerDeleteDangerZone({store,cid,setCid,setView}:any){
 const c=cobj(store.data,cid)
 const [busy,setBusy]=useState(false)
 const [msg,setMsg]=useState('')
 if(!c)return null
 const relatedTables=['customer_subscriptions','customer_tool_access','customer_reactivation_events','customer_reactivation_links','customer_reactivation_settings','customer_invites','customer_registrations','customer_users','customer_notes','customer_files','invoices','tickets','ticket_messages','appointments','customer_clients','offers','automations','workflow_runs','activity_logs','integrations','oauth_tokens','seo_snapshots','notifications','customer_service_categories','customer_seo_metrics','review_funnel_stats','client_success_events','qr_campaigns','review_feedback','competitor_benchmarks','google_business_audits','mini_audits','prospect_leads','generated_offers','generated_contracts','dunning_cases','customer_health_scores','acquisition_campaigns','onboarding_checklists','monthly_reports','approval_requests','output_documents','loyalty_customers','loyalty_transactions','loyalty_reward_redemptions','loyalty_programs','loyalty_rewards','loyalty_reward_rules','staff_codes','public_landing_pages','sales_workflows','sales_workflow_events','sales_workflow_documents']
 async function deleteCustomer(){
  setMsg('')
  if(!cid)return
  if(!confirmAction(`Kunden „${c.name}“ wirklich löschen?`))return
  if(!confirmAction('Dieser Kunde wird aus CRM/Kundenliste entfernt. Verknüpfte Reports, Rechnungen, QR-Daten und Zugänge werden nach Möglichkeit ebenfalls entfernt. Fortfahren?'))return
  setBusy(true)
  ...
  try{
   ...
   store.notify?.('Kunde gelöscht')
  }catch(e:any){
   setMsg('Kunde konnte nicht vollständig gelöscht werden: '+compactLiveError(e))
  }finally{setBusy(false)}
 }
 return <Card title="Gefahrenbereich" action={<Badge type="red">Admin</Badge>}><div className="item"><div><b>Kundenakte löschen</b><div className="sub">Entfernt den ausgewählten Kunden aus CRM und Kundenportal. Bitte nur nutzen, wenn der Kunde wirklich nicht mehr benötigt wird.</div></div><button className="btn secondary" onClick={deleteCustomer} disabled={busy}>{busy?'Löscht...':'Kunde löschen'}</button></div>{msg&&<div className="sub">{msg}</div>}</Card>
}
...
async function apply(pkg:string){
  ...
  const allTools=Array.from(new Set([...Object.values(packageDefs).flatMap((p:any)=>p.tools),'Rückholaktionen']))
...
function GuidedOnboardingCenter({store,cid,role,setCid,setView}:any){
 ...
 async function bootstrap(){
  ...
  try{
   ...
   if(!(store.data.qr_campaigns||[]).some((q:any)=>q.customer_id===target)) await store.create('qr_campaigns',{customer_id:target,title:`${customerDisplayName(customer)} QR Start`,slug:slugifyLocal(`${customerDisplayName(customer)}-start`),purpose:'review',points_per_scan:10,status:'Aktiv',active:true,created_at:new Date().toISOString()})
...
const v33ToolConfigs:any={
 qr:{title:'QR Kampagnen verwalten',category:'QR Kampagnen',resource:'qr_campaigns',fields:['title','purpose','points_per_scan','max_scans_per_member','daily_scan_limit_per_member','scan_cooldown_minutes','daily_point_limit_per_member','suspicion_score_threshold','require_rescan_for_points','rotate_qr_after_scan'],defaults:[],special:'qr'},
 public_landing:{title:'QR Zielseite',category:'QR Kampagnen',resource:'public_landing_pages',fields:['title','slug','headline','mode'],defaults:[]},
 loyalty:{title:'Punkteprogramm',category:'QR Kampagnen',resource:'loyalty_programs',fields:['name','qr_campaign_id','points_per_scan','daily_point_limit_per_member','suspicion_score_threshold'],defaults:[]},
 loyalty_rewards:{title:'Prämien',category:'QR Kampagnen',resource:'loyalty_rewards',fields:['name','reward_type','required_points','qr_campaign_id','staff_code_required','allow_multiple_redemptions','max_redemptions_per_member'],defaults:[]},
 loyalty_rules:{title:'Regeln',category:'QR Kampagnen',resource:'loyalty_reward_rules',fields:['name','trigger','condition','points','multiplier','qr_campaign_id'],defaults:[]},
 staff_codes:{title:'Mitarbeitercodes',category:'QR Kampagnen',resource:'staff_codes',fields:['label','code','qr_campaign_id'],defaults:[],special:'staff'},
 loyalty_segments:{title:'Kundengruppen',category:'QR Kampagnen',resource:'loyalty_segments',fields:['name','rule','members'],defaults:[]},
 smart_loyalty:{title:'Bonusstufen',category:'QR Kampagnen',resource:'loyalty_members',fields:['name','points','tier'],defaults:[]},
 ...
 smart_automation:{title:'Automatische Regeln',category:'Automatische Aktionen',resource:'smart_automations',fields:['name','trigger','action'],defaults:[]},
 marketing_automation:{title:'Automatische Aktionen',category:'Automatische Aktionen',resource:'marketing_campaigns',fields:['name','audience','reward','status'],defaults:[]},
 ai_assistant:{title:'KI-Empfehlungen',category:'Automatische Aktionen',resource:'assistant_messages',fields:['title','severity','message'],defaults:[]},
 customer_health:{title:'Projektstatus',category:'Auswertung & Abrechnung',resource:'customer_health',fields:['name','score','note'],defaults:[]},
 customer_intelligence:{title:'Empfehlungen',category:'Auswertung & Abrechnung',resource:'customer_intelligence',fields:['name','score','recommendation'],defaults:[]},
 dynamic_billing:{title:'Nutzung & Abrechnung',category:'Auswertung & Abrechnung',resource:'dynamic_billing_usage',fields:['label','quantity','unit'],defaults:[]},
 revenue_forecasting:{title:'Umsatzprognose',category:'Auswertung & Abrechnung',resource:'revenue_forecasts',fields:['period','expected','confidence'],defaults:[]},
 revenue_share:{title:'Umsatzbeteiligung',category:'Auswertung & Abrechnung',resource:'revenue_shares',fields:['name','gross','percent'],defaults:[]},
 package_recommendations:{title:'Paket-Empfehlung',category:'Auswertung & Abrechnung',resource:'package_recommendations',fields:['title','uplift','confidence'],defaults:[]},
 package_matrix:{title:'Paket-Matrix',category:'Analytics & Billing',resource:'package_matrix',fields:['name','tools','price'],defaults:[]},

  retention_intelligence:{title:'Kundenbindung',category:'QR, Punkte & Automation',resource:'retention_intelligence',fields:['name','score','recommendation','status'],defaults:[]},
  consent_center:{title:'Einwilligungen',category:'QR, Punkte & Automation',resource:'consent_center',fields:['name','channel','status','note'],defaults:[]},
  segment_campaigns:{title:'Kundenaktionen',category:'QR, Punkte & Automation',resource:'segment_campaigns',fields:['name','audience','reward','status'],defaults:[]},
  churn_prevention:{title:'Rückhol-Chancen',category:'QR, Punkte & Automation',resource:'churn_prevention',fields:['name','risk','action','status'],defaults:[]},
...
function V66PackageMatrixEditor({store}:any){
 ...
 async function save(){
  ...
  try{
   ...
   const payload={id:'main',scope:'public_home',packages,updated_at:new Date().toISOString()}
...
function V30ToolModule({view,store,cid,role,setCid}:any){
 ...
 // v42_router_patch
 if(['loyalty','loyalty_rewards','loyalty_rules','loyalty_segments','smart_loyalty'].includes(view))return <><Head title="QR Zielseite" sub="Punkte, Prämien und Einlöse-Regeln werden nur noch zentral unter QR Zielseite gepflegt."/><Card title="Bereich zusammengeführt"><div className="sub">Dieser alte Einzelbereich wurde bereinigt. Bitte nutze unten die QR-Zielseite: Dort stellst du Punkte, Limits, Prämien und öffentliche Texte pro Kampagne ein.</div></Card><V42PublicLandingManager store={store} cid={cid}/></>
 ...
 if(view==='ai_assistant')return <><CentralCustomerSelector store={store} cid={cid} setCid={role==='admin'?setCid:undefined} title='KI-Empfehlungen · Kunde'/><V41AiAssistantDetail cid={cid}/></>
 if(view==='customer_health')return <><CentralCustomerSelector store={store} cid={cid} setCid={role==='admin'?setCid:undefined} title='Projektstatus · Kunde'/><V40StatusRadar cid={cid} store={store} mode="health"/></>
 if(view==='customer_intelligence')return <><CentralCustomerSelector store={store} cid={cid} setCid={role==='admin'?setCid:undefined} title='Empfehlungen · Kunde'/><V41CustomerIntelligenceDetail cid={cid}/></>
 if(view==='dynamic_billing')return <V40RevenueChart cid={cid} mode="billing"/>
 if(view==='revenue_forecasting')return <><CentralCustomerSelector store={store} cid={cid} setCid={role==='admin'?setCid:undefined} title='Umsatzprognose · Kunde'/><V41PrognoseDetail cid={cid}/></>
 if(view==='revenue_share')return <><CentralCustomerSelector store={store} cid={cid} setCid={role==='admin'?setCid:undefined} title='Umsatzbeteiligung · Kunde'/><V41RevenueShareDetail cid={cid}/></>
 ...
 function runAction(row:any){
  ...
  if(view==='revenue_forecasting'||view==='customer_health'||view==='customer_intelligence'||view==='revenue_share'||view==='package_recommendations')return v33FunctionalClient.recalculateCustomer(cid).then((r:any)=>setMsg(`Business Engine neu berechnet: Status ${r.snapshot?.health}, Upgrade ${r.snapshot?.upsell}`)).catch((e:any)=>setMsg(e.message))
 ...
 function renderField(k:string){
  ...
  const numericFields=['points','score','quantity','unit','expected','confidence','gross','percent','tools','price','max_redemptions_per_member','max_scans_per_member','daily_scan_limit_per_member','scan_cooldown_minutes','daily_point_limit_per_member','suspicion_score_threshold','points_per_scan','required_points','multiplier','members','rating'].includes(k)
