...
const seed:any={
 ...
 customer_files:[
  {id:'f1',customer_id:ids.barber,name:'Re_Barber_Lounge_Rostock_1.pdf',file_type:'invoices',mime_type:'application/pdf',size_bytes:142000,version:1,actor_name:'DominiqueMM',created_at:'2026-05-01',url:'#'},
  {id:'f2',customer_id:ids.barber,name:'Growth_Vertrag.pdf',file_type:'contracts',mime_type:'application/pdf',size_bytes:98000,version:1,actor_name:'DominiqueMM',created_at:'2026-05-02',url:'#'}
 ],
...
function ProfileUpload({activeAdmin,setAdminAvatars,adminAvatars}:any){
  ...
  function pick(e:any){
    ...
    setAdminAvatars((p:any)=>({...p,[activeAdmin]:url}))
  }
  return <div className="profileWrap">
    ...
    {open&&<div className="profilePanel">
      ...
      <div className="sub">Profilbild wird lokal als Preview gesetzt und bei neuen Änderungen angezeigt. Für dauerhafte Speicherung muss später Storage/Auth-Profil angebunden werden.</div>
    </div>}
  </div>
}
