...
export default function App(){
 ...
 const adminNavGroups=[
    ...
    },
    {
      ...
      tools:['qr','public_landing','loyalty','loyalty_rewards','loyalty_rules','staff_codes','loyalty_segments','smart_loyalty','automations','workflows','smart_automation','marketing_automation','ai_assistant','customer_workflows','output_engine','timeline_events']
    },
    {
      label:'Finanzen & Pakete',
      hint:'Rechnungen, Mahnwesen, Forecast, Billing, Paketlogik und Empfehlungen',
      tools:['finance','dunning','dynamic_billing','revenue_forecasting','revenue_share','package_recommendations','package_matrix','packages']
    },
    {
