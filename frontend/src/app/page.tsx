...
function QRCodes({store,cid,setCid,role='admin',activeView='qr'}:any){
 ...
 const sectionFromView=(v:string)=>['public_landing','loyalty','loyalty_rewards','loyalty_rules','staff_codes','reactivation','loyalty_segments','smart_loyalty'].includes(v)?v:(['churn_prevention','retention_intelligence','customer_reactivation'].includes(v)?'reactivation':'campaigns')
 ...
 const growthQrSections=['campaigns','public_landing','staff_codes']
 const loyaltyAddonSections=['public_landing','staff_codes','reactivation','loyalty','loyalty_rewards','loyalty_rules','loyalty_segments','smart_loyalty']
