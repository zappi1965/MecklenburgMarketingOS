...
export default function App(){
 ...
 const adminNavGroups=[
   {label:'Übersicht & Kunden',hint:'Dashboard, Verkaufsworkflow, CRM und Kundenstatus',tools:['dashboard','sales_workflow','crm','pipeline','customer_health','customer_intelligence']},
   {label:'Akquise & Abschluss',hint:'Leads, Audits, Angebote und Verträge',tools:['business_audit','mini_audit','lead_scraper','acquisition_campaigns','offer_generator','contract_generator']},
   {label:'Sichtbarkeit & Reputation',hint:'SEO, Integrationen, KPIs, Reviews und Wettbewerb',tools:['integrations','seo','kpi','competitors','reviews','review_intelligence','review_templates']},
   {label:'QR, Loyalty & Automation',hint:'QR, Loyalty, Landingpages, Workflows und AI',tools:['qr','public_landing','loyalty','loyalty_rewards','loyalty_rules','staff_codes','loyalty_segments','smart_loyalty','automations','workflows','smart_automation','marketing_automation','ai_assistant','customer_workflows']},
   {label:'Service & Delivery',hint:'Tickets, Termine, Media, Reports, Freigaben und Onboarding',tools:['tickets','booking','media','reports','monthly_reports','approvals','knowledge','onboarding']}
 ]
