  ...
  return (
    <ToolAccessGate toolKey="referral_program">
      <div className="adminPage">
        ...
        {isAdmin ? (
          <section className="adminCard" style={{ display: 'grid', gap: 8, maxWidth: 520, marginBottom: 16 }}>
            ...
            <p style={{ opacity: 0.7, margin: 0 }}>Empfehlungen und Bonusregeln beziehen sich auf den ausgewählten Kunden.</p>
          </section>
        ) : null}
