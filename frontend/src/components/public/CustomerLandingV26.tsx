...
.plan .badge{position:absolute;top:16px;right:16px;left:auto;bottom:auto;width:max-content;max-width:none;min-width:0;display:inline-flex;align-items:center;background:var(--grad);color:#fff;padding:.36rem .65rem;border-radius:999px;font-size:.72rem;font-weight:850;line-height:1.1;letter-spacing:0;box-shadow:none;z-index:3}
.plan.featured h3{padding-right:78px}
