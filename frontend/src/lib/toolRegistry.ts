...
,
  ...
  { key: 'deal_of_week', label: 'Deal der Woche / Aktionen', area: 'shared', section: 'marketing', packageMin: 'growth', route: '/marketing/deals', adminRoute: '/admin/marketing/deals', customerRoute: '/marketing/deals', description: 'Zeitlich begrenzte Aktionsseiten mit Countdown, QR fuers Schaufenster und Teilen-Funktion.', visibleToCustomer: true, icon: 'megaphone' },
