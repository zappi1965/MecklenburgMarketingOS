...
export const sectionMeta: Record<SectionKey, SectionMeta> = {
  ...
  qr_loyalty: { key: 'qr_loyalty', label: 'QR & Punkteprogramm',      icon: 'qr-code' },
...
export const mmosToolRegistry: MmosTool[] = [
  ...
  { key: 'slug_endcustomer_hub', label: 'Slug-Endkundenhub', area: 'shared', section: 'qr_loyalty', packageMin: 'growth', route: '/slug-hub', description: 'Bewertungen, Punkteprogramm, Gutscheine, Termine und Empfehlungen auf einer Endkundenseite.', visibleToCustomer: true, icon: 'link' },
  ...
  { key: 'loyalty_growth_center', label: 'Punkteprogramm Growth', area: 'shared', section: 'qr_loyalty', packageMin: 'growth', route: '/loyalty/growth', description: 'Umsatzlogik, Wiederkehrer-Ziele und Punkteprogramm-Wachstum.', visibleToCustomer: true, icon: 'gift' },
  ...
  { key: 'automation_playbooks', label: 'Automation Playbooks', area: 'shared', section: 'automation', packageMin: 'premium', route: '/automation/playbooks', description: 'Standard-Automationen fuer Reviews, Termine, Rechnungen, SEO und Punkteprogramm.', visibleToCustomer: true, icon: 'bot' },
...
,
  ...
  { key: 'timeline', label: 'Timeline Events', area: 'shared', section: 'crm', packageMin: 'growth', route: '/timeline', description: 'Chronologische Verknuepfung aus QR, Punkteprogramm, Reviews, Billing und Tickets.', visibleToCustomer: true, icon: 'history' },
  ...
  { key: 'public_landing_page', label: 'Oeffentliche /l/[slug]', area: 'shared', section: 'qr_loyalty', packageMin: 'growth', route: '/l/[slug]', description: 'Oeffentliche Endkundenseite fuer QR, Review und Punkteprogramm.', visibleToCustomer: true, icon: 'link' },
  { key: 'loyalty', label: 'Punkteprogramm', area: 'shared', section: 'qr_loyalty', packageMin: 'growth', route: '/loyalty', description: 'Punkteprogramm ueber QR-Code mit Kampagnenverknuepfung.', visibleToCustomer: true, icon: 'gift' },
  { key: 'loyalty_rewards', label: 'Prämien', area: 'shared', section: 'qr_loyalty', packageMin: 'growth', route: '/loyalty/rewards', description: 'Einloesbare Praemien, Rabatte oder Vorteile fuer gesammelte Punkte.', visibleToCustomer: true, icon: 'badge-check' },
  { key: 'loyalty_reward_rules', label: 'Regeln', area: 'shared', section: 'qr_loyalty', packageMin: 'premium', route: '/loyalty/rules', description: 'Konfiguration von Reward-Typen, Punktebedarf und Bedingungen.', visibleToCustomer: true, icon: 'sliders-horizontal' },
  { key: 'referral_program', label: 'Empfehlungsprogramm', area: 'shared', section: 'qr_loyalty', packageMin: 'premium', route: '/referrals', description: 'Empfehlungslinks, QR-Empfehlungen, Praemienlogik und Punkteprogramm-Anbindung.', visibleToCustomer: true, icon: 'share-2' },
  ...
  { key: 'seo_autopilot', label: 'SEO-Autopilot', area: 'admin', section: 'marketing', packageMin: 'premium', route: '/admin/seo-autopilot', adminRoute: '/admin/seo-autopilot', description: 'KI-gestuetzte SEO-Inhalte pro Kunde: Brand-DNA, Keyword-Ideen und vollstaendige Artikel zur Freigabe (Mock ohne API-Key, Claude/GPT mit Key).', visibleToCustomer: false, icon: 'wand-2' },
  { key: 'deal_of_week', label: 'Aktionen & Angebote', area: 'shared', section: 'qr_loyalty', packageMin: 'growth', route: '/marketing/deals', adminRoute: '/admin/marketing/deals', customerRoute: '/marketing/deals', description: 'Konkrete Wochenangebote, Rabatte und Angebotsseiten als Ergänzung zu QR-Kampagnen. Bonusaktionen wie doppelte Punkte bleiben in der QR-Zielseite.', visibleToCustomer: true, icon: 'megaphone' },
  { key: 'mini_website', label: 'Mini-Website & Google-Booster', area: 'shared', section: 'marketing', packageMin: 'growth', route: '/marketing/mini-website', adminRoute: '/admin/marketing/mini-website', customerRoute: '/marketing/mini-website', description: 'Oeffentliche One-Pager-Microsite aus MMOS-Daten plus Google-Booster-Checkliste aus dem Mini-Audit.', visibleToCustomer: true, icon: 'map' },
  { key: 'branche_benchmark', label: 'Branchen-Benchmark Report', area: 'shared', section: 'analytics', packageMin: 'premium', route: '/analytics/benchmark', adminRoute: '/admin/analytics/benchmark', customerRoute: '/portal/reports', description: 'Monatlicher Branchenvergleich (k-anonym) der eigenen KPIs gegen anonymisierte Peers, mit Branchen-Zielwerten als Fallback.', visibleToCustomer: true, icon: 'line-chart' },
  ...
  { key: 'marketing_automation', label: 'Marketing Automation', area: 'shared', section: 'marketing', packageMin: 'premium', route: '/marketing/automation', description: 'Reaktivierung, Review Booster, Punkteprogramm-Boost und Kampagnen.', visibleToCustomer: true, icon: 'megaphone', mobilePriority: 5 },
  ...
  { key: 'smart_automation', label: 'Smart Automation', area: 'shared', section: 'automation', packageMin: 'premium', route: '/automation/smart', description: 'Regelbasierte Automationen aus QR, Punkteprogramm, Reviews und Health.', visibleToCustomer: true, icon: 'bot' },
