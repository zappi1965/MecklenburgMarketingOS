...
export const mmosToolRegistry: MmosTool[] = [
  ...
  { key: 'pos_integration', label: 'Kassen-Anbindung (POS)', area: 'shared', section: 'operations', packageMin: 'premium', route: '/admin/pos', description: 'POS-/SumUp-Transaktionen per Webhook als Live-Liste mit Umsatzsumme.', visibleToCustomer: true, icon: 'credit-card' },
